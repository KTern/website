...
// SEO Tags
import { NextSeo, BreadcrumbJsonLd, LogoJsonLd, EventJsonLd } from 'next-seo';
  ...
  return (
    <body className="">
      ...
      <Layout h_data={h_data} f_data={f_data} className="events">
                ...
                <div className="flex space-x-4 mt-10">
                  ...
                  >
                    <a
                      ...
                      className={
                        'inline-block py-3 px-10  bg-black border-2 border-white text-white hover:bg-secondary hover:text-black shadow text-black  rounded-r-xl rounded-b-xl transition duration-200 uppercase border-2 border-black  hyperlink button'
                      }
                    >
                  ...
                  {!countDownState && (
                    ...
                    >
                      <a
                        ...
                        className={
                          'inline-block py-3 px-10  bg-white text-black hover:bg-secondary hover:text-black shadow text-black  rounded-r-xl rounded-b-xl transition duration-200 uppercase border-2 border-black  hyperlink button'
                        }
                      >
        ...
        >
          <div className=" px-4 mx-auto">
            ...
            {/* <p>Lorem ipsum dolor sit amet, consectetur
             adipisicing elit. ab repudiandae et.</p> */}
          </div>
          <Carousel
              ...
              >
                {data.events.map((data) => (
                  ...
                  >
                    <div
                      className={
                        'relative  bg-white flex-col p-5 px-5  group false rounded-xl shadow-lg '
                      }
                    >
        ...
        >
          <div className="hidden md:block absolute top-0 right-0 w-1/2 h-full  rounded-b-10xl" />
          <div className="relative  mx-auto">
            <div className="flex flex-wrap items-center text-center">
              <div className="w-full md:w-1/2 px-6 md:px-20">
                ...
                <Link href={data.accessReportSection.CTAUrl} passHref>
                  <a
                    ...
                    className={
                      'inline-block mb-10 md:mb-0 py-3 px-10  bg-black border-2 border-white text-white hover:bg-secondary hover:text-black shadow text-black  rounded-r-xl rounded-b-xl transition duration-200 uppercase border-2 border-black  hyperlink button'
                    }
                  >
              ...
              <div className="relative w-full md:w-1/2 px-10   ">
                <div className="md:hidden absolute bottom-0 left-0 h-full w-full rounded-b-xl10 " />
