          ...
          <section className="overflow-hidden  pt-4">
            <div
              style={{
                ...
                backgroundImage: windowSize>400 ? `url(${data.heroSection.ImageURL})`:`url(${data.heroSection.alternateImageUrl})`,
					...
					<section  id={data.SectionID.Speakers} className="anchor relative bg-white pb-10 sm:px-6 pt-5 events">
						<div className="container mx-auto text-center">
							<div className=" mx-auto mb-8">
								...
								<h2 className="section-heading mt-2 mb-4 ">{data.speakers.heading}</h2>
								<p className="text-sky-700 leading-loose section-subheading">{data.speakers.subHeading}</p>
							</div>
						</div>
						<div className="relative container px-4 mx-auto">
							<div className="flex flex-wrap -mx-4 items-center justify-center">
								{data.speakers.speakersList.map((dt) => (
									<div key="dt" className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 px-4 mb-10">
										<div className="text-center max-w-xs mx-auto">
											<Image
												priority
												width={dt.imageWidth}
						...
						<section  id={data.SectionID.Registration} className="anchor events">
							<section className="py-5 pb-10 px-5">
								...
								<div className="grid grid-cols-2 sm:grid-cols-1 ">
									...
									<div className="md:mx-16">
										<div className=" relative z-10 h-auto p-8  overflow-hidden bg-white border-b-2 border-gray-300 rounded-lg shadow-2xl px-7">
											<h3 className="mb-6 card-heading  text-center">{data.form.title}</h3>
											{thanksState && (
												<div
													id="thanks_container"
													className="block  mb-5 bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md"
												...
												>
													<div className="flex ">
														...
														<div>
															<p className="font-bold card-subheading">{data.form.ThanksMessage}</p>
														</div>
													</div>
												</div>
											)}
											...
											>
												<div id="SIGNUP_BODY_ALL" name="SIGNUP_BODY_ALL">
													<div id="SIGNUP_BODY" name="SIGNUP_BODY">
														<div>
															<div>
																<div name="fieldsdivSf" className="flex-col space-y-5">
																	<div className="zcsffield " fieldid="71738000000000023">
																		<div>
																			<label
																	...
																	<div className="zcsffield " fieldid="71738000000000029">
																		<div>
																			<label
																				className="absolute px-2 ml-2 -mt-3 card-subheading font-bold text-black bg-white"
																				htmlFor="FIRSTNAME"
