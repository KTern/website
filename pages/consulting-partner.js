        ...
        <Layout>                
            ...
            <div className="flex flex-col items-center px-4 mx-auto max-w-7xl lg:flex-row">
                <div className="relative z-20 flex flex-col items-start justify-center w-full h-full lg:w-1/2">
                    <p className="inline-block uppercase px-2 py-1 mb-5  hyperlink  text-gray-900 uppercase bg-gray-200 rounded-full ">
                ...
                <div className="flex items-center card-heading space-x-4">
                   <Link  href="/become-a-partner" passHref><a className="hidden mb-1 lg:inline-block py-2 px-6 bg-black hover:bg-gray-300 hover:text-black shadow uppercase text-white  rounded-l-xl hyperlink rounded-t-xl transition duration-200 ">Become a Partner</a></Link>
                    <Link href=""  passHref>
                        <a className="inline-flex items-center card-heading hyperlink uppercase text-gray-400 underline transition-colors duration-200 ">Partner Portal
                ...
                <div className="grid grid-cols-3 gap-5 mt-10 sm:grid-cols-8 lg:grid-cols-12">
                    <div className="max-w-xs col-span-4  border-0 border-gray-200 text-gray-50">
                        <div className="box-border flex flex-col items-center h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:items-start sm:text-left">
                            ...
                            <div className="mt-6  text-center border-0 border-gray-200 sm:text-left text-gray-50">
                                <span className="box-border card-heading    border-solid text-gray-50">Zero Cost</span>
                                <p className="box-border mx-0 mt-2 mb-0  card-subheading  text-center text-gray-300 border-solid sm:text-left">Becoming a KTern Consulting Partner comes at no cost at all.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-xs col-span-4  border-0 border-gray-200 text-gray-50">
                        <div className="box-border flex flex-col items-center h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:items-start sm:text-left">
                            ...
                            <div className="mt-6  text-center border-0 border-gray-200 sm:text-left text-gray-50">
                                <span className="box-border card-heading    text-center border-solid sm:text-left text-gray-50">Access to Demo Account</span>
                    ...
                    <div className="max-w-xs col-span-4  border-0 border-gray-200 text-gray-50">
                        <div className="box-border flex flex-col items-center h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:items-start sm:text-left">
                            ...
                            <div className="mt-6  text-center border-0 border-gray-200 sm:text-left text-gray-50">
                                <span className="box-border card-heading    text-center border-solid sm:text-left text-gray-50">Exclusive Partner Team</span>
                                <p className="box-border mx-0 mt-2 mb-0  card-subheading text-center text-gray-300 border-solid sm:text-left">Exclusive Partner Team to support your Business.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-xs col-span-4  border-0 border-gray-200 text-gray-50">
                        <div className="box-border flex flex-col items-center h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:items-start sm:text-left">
                            ...
                            <div className="mt-6  text-center border-0 border-gray-200 sm:text-left text-gray-50">
                                <span className="box-border card-heading    text-center border-solid sm:text-left text-gray-50">Training and Enablement</span>
                                <p className="box-border mx-0 mt-2 mb-0  card-subheadingtext-center text-gray-300 border-solid sm:text-left">Training is conducted free of cost by KTern&apos;s Enablement team</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-xs col-span-4  border-0 border-gray-200 text-gray-50">
                        <div className="box-border flex flex-col items-center h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:items-start sm:text-left">
                            ...
                            <div className="mt-6  text-center border-0 border-gray-200 sm:text-left text-gray-50">
                                <span className="box-border card-heading    text-center border-solid sm:text-left text-gray-50">Fast and Reliable</span>
                                <p className="box-border mx-0 mt-2 mb-0  card-subheading text-center text-gray-300 border-solid sm:text-left">Our system has a 99.9% uptime and is extremely fast and reliable.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-xs col-span-4  border-0 border-gray-200 text-gray-50">
                        <div className="box-border flex flex-col items-center h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:items-start sm:text-left">
                            ...
                            <div className="mt-6  text-center border-0 border-gray-200 sm:text-left text-gray-50">
                                <span className="box-border card-heading    text-center border-solid sm:text-left text-gray-50">Incentives</span>
                                <p className="box-border mx-0 mt-2 mb-0  card-subheading text-center text-gray-300 border-solid sm:text-left">The rewards and incentives just keeps going up</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="container px-20 mx-auto">
                ...
                <div className="mb-16 overflow-x-auto overflow-y-hidden">
                    ...
                    <thead className="bg-gray-100">
                        ...
                        <th className="pl-16 py-5 card-heading">Enablement</th>
                    ...
                    <tbody>
                        ...
                        <td className="pl-16 py-6 text-left card-subheading uppercase">Access to Partner Portal</td>
                        <td className="pl-10">
                        ...
                        <tr className="text-lg text-center border-b border-gray-50">
                        <td className="pl-16 py-6 text-left card-subheading uppercase">Marketing and Sales Kit</td>
                        <td></td>
                        <td className="pl-10">
                            <svg width="36" height="37" viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="18" cy="18.4595" r="18" fill="#111827" fillOpacity="0.1"></circle>
                        ...
                        <tr className="text-lg text-center border-b border-gray-50">
                        <td className="pl-16 py-6 text-left card-subheading uppercase">Newsletters and Feature Releases</td>
                        <td></td>
                        <td></td>
                        <td className="pl-10">
                            <svg width="36" height="37" viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <td className="pl-16 py-6 text-left card-subheading uppercase">Dedicated Channel Manager</td>
                        <td></td>
                        <td className="pl-10">
                            <svg width="36" height="37" viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="18" cy="18.4595" r="18" fill="#111827" fillOpacity="0.1"></circle>
                ...
                <div className="mb-16 overflow-x-auto overflow-y-hidden">
                    ...
                    <tbody>
                        <tr className="text-lg text-center border-b border-gray-50">
                        <td className="pl-16 py-6 text-left card-subheading uppercase">Product Training</td>
                        <td className="pl-10">
                            <svg width="36" height="37" viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="18" cy="18.4595" r="18" fill="#111827" fillOpacity="0.1"></circle>
                            <g clipPath="url(#clip0)">
                        ...
                        <tr className="text-lg text-center border-b border-gray-50">
                        <td className="pl-16 py-6 text-left card-subheading uppercase">Platform Training</td>
                        <td className="pl-10">
                            <svg width="36" height="37" viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="18" cy="18.4595" r="18" fill="#111827" fillOpacity="0.1"></circle>
                            <g clipPath="url(#clip0)">
                        ...
                        <tr className="text-lg text-center border-b border-gray-50">
                        <td className="pl-16 py-6 text-left card-subheading uppercase">Sales Training</td>
                        <td className="pl-10">
                            <svg width="36" height="37" viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="18" cy="18.4595" r="18" fill="#111827" fillOpacity="0.1"></circle>
                            <g clipPath="url(#clip0)">
                        ...
                        <tr className="text-lg text-center">
                        <td className="pl-16 py-6 text-left card-subheading uppercase">New Product Beta</td>
                        <td></td>
                        <td></td>
                        <td className="pl-10">
                            <svg width="36" height="37" viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="overflow-x-auto overflow-y-hidden">
                    ...
                    <tbody>
                        <tr className="text-lg text-center border-b border-gray-50">
                        <td className="pl-16 py-6 text-left card-subheading uppercase">Listing on KTern Website</td>
                        <td className="pl-10">
                            <svg width="36" height="37" viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="18" cy="18.4595" r="18" fill="#111827" fillOpacity="0.1"></circle>
                            <g clipPath="url(#clip0)">
                        ...
                        <tr className="text-lg text-center border-b border-gray-50">
                        <td className="pl-16 py-6 text-left card-subheading uppercase">KTern Partner Logo</td>
                        <td></td>
                        <td></td>
                        <td className="pl-10">
                            <svg width="36" height="37" viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="p-10 md:p-20 bg-secondary radius-for-skewed">
                    ...
                    <div className="lg:flex shadow-2xl bg-white items-center justify-center md:space-x-8">
                        ...
                        <div className="md:py-10 text-center w-full lg:w-1/3 border-r">
                            <span className="text-5xl lg:text-6xl ">4.7</span>
                        ...
                        <div className="md:py-10 px-6 w-full lg:w-2/3">
                            ...
                            <h4 className="text-2xl  card-heading">Jim W</h4>
                    ...
                    <div className="flex space-x-10 p-10">
                        <div className="container  w-1/2  space-y-4">
                                ...
                                <details className="relative overflow-hidden border-2 border-gray-200  select-none hover:bg-white">
                                    <summary  className=" flex items-center card-heading justify-between   text-gray-700 cursor-pointer sm: px-6 py-6 hover:text-gray-800" style={{ listStyle: 'none' }}>
...
{/* <!-- Footer CTA --> */}
           <section className="bg-white">
                ...
                <Link  href="/pricing" passHref><a className="  inline-block py-3 px-10 bg-black hover:bg-gray-100 hover:text-black shadow   text-white  rounded-r-xl rounded-b-xl transition duration-200 button ">See Pricing</a></Link>
