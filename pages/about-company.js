...
export default function About({ data, h_data, f_data, n_data }) {
  ...
  return <>
    ...
    <Layout h_data={h_data} f_data={f_data}>
      <div className="background bg-cover pt-10 ">
        {" "}
          ...
          <div className="flex flex-col space-x-10 items-center justify-center md:mx-auto  xl:p-8 lg:flex-row lg:max-w-7xl lg:p-0">
            <div className="container space-y-5 relative z-20 flex flex-col w-full px-5 pb-1 pr-12 mb-16 text-2xl text-white lg:w-1/2 sm:pr-0 md:pr-6 md:pl-0 lg:pl-5 xl:pr-10 sm:items-center lg:items-start lg:mb-0">
              <h1 className="relative z-20   leading-none text-white heading  sm:text-center lg:text-left">
                ...
                <br />
                <span className=" text-gray-400 heading ">
                  {data.PageHeader.header2}
                </span>
              </h1>
      ...
      <section
        id="mission"
        className="anchor  lg:max-w-7xl text-justify px-12 relative w-full md:mx-auto  md:py-5 px-4 bg-white flex flex-col md:flex-row"
      >
        <div className=" w-full mx-auto flex-col justify-center items-center text-center w-full py-4">
          <p className="mb-4 section-heading text-black ">
            {data.vision.title}
          </p>
          <div className=" mb-10">
      ...
      <div className="flex flex-wrap mx-auto bg-black text-white md:p-20  md:px-24 ">
        ...
        <div className="w-full md:w-3/4 pr-10 mb-4 md:mb-0 flex ">
          <div className="w-full ">
            {data.Values.Steps.map((dt, index) => (
              <div className="w-full  flex  px-20" key="dt">
                {index % 2 == 0 && (
                  <div className=" md:text-left  md:w-full">
                    <span className="  md:flex-col ">
                      <div
                        className="text-7xl  md:bg-values_gradient bg-no-repeat  md:pl-8 "
                        style={{
                          backgroundSize: "26%",
                      ...
                      <div className="card-heading">{dt.StepTitle}</div>
                ...
                {index % 2 != 0 && (
                  <div className=" md:text-right md:w-full">
                    <span className=" md:flex-col ">
                      <div
                        className="text-7xl  md:bg-values_gradient bg-no-repeat  md:pr-8 "
                        style={{
                          backgroundSize: "26%",
      ...
      <section className="md:flex md:space-x-16 py-10 px-10 ">
        ...
        <section className="md:w-1/2 sm:w-full text-justify   bg-white ">
          <div className="hidden md:block">
            <Image
              priority
              src={data.AcademicAlliance.Images.imageURL}
              alt={data.AcademicAlliance.Images.imageDescription}
              height={data.AcademicAlliance.Images.height}
              width={data.AcademicAlliance.Images.width}
            />
          </div>
          <p className="mb-5 card-heading text-black sm:text-center ">
            {data.AcademicAlliance.Title}
          </p>

          <div className="w-full mt-5 md:mt-0  ">
            <h3 className="mb-5 card-subheading  ">
              {" "}
              <Markdown
                options={{
                  overrides: {
        ...
        <section className=" md:w-1/2 sm:w-full text-justify bg-white ">
          <div className="hidden md:block">
            <Image
              priority
              src={data.DigitalDhaanam.Images.imageURL}
              alt={data.DigitalDhaanam.Images.imageDescription}
              height={data.DigitalDhaanam.Images.height}
              width={data.DigitalDhaanam.Images.width}
            />
          </div>
          <p className="mb-5 card-heading text-black sm:text-center ">
            {data.DigitalDhaanam.Title}
          </p>

          <div className="w-full mt-5 md:mt-0  ">
            <h3 className="mb-5 -mt-1 card-subheading  ">
              {" "}
              <Markdown
                options={{
                  overrides: {
      ...
      <section className="bg-black overflow-hidden">
        <div className="relative px-16 pt-10 pb-12 mx-auto max-w-7xl xl:px-16">
          <svg
            className="relative z-10 w-16 mb-8 text-gray-100 transform opacity-100 fill-current sm:w-20 -rotate-0 rotate rotate-3"
          ...
          <div className="relative z-20">
            <h3 className="section-heading text-left text-white ">
              {data.FastFacts.Title}
            </h3>
            <div className="md:flex  md:space-x-5 mt-4 sm:flex-row items-center">
              <p className="section-subheading text-left text-gray-100">
                {data.FastFacts.Description}
              </p>
            ...
            {data.FastFacts.Steps.map((dt) => (
              <div key="dt" className="flex text-white">
                ...
                <div className="relative space-y-2">
                  ...
                  <p className="card-subheading text-gray-300">
                    {dt.StepDescription}
                  </p>
                </div>
              </div>
      ...
      <section className="w-full py-10 pb-16 bg-secondary">
        <div className="flex flex-col items-center max-w-6xl px-10 mx-auto xl:px-0">
          <p className="card-heading text-gray-400 uppercase">
            {data.ourcustomerstitle}
          </p>
              ...
              (<Link
                ...
                onClick={() => {
                  onClick({
                    ...
                    section_name: "Related News Section",
                    page_source: `${data.PageSEO.PageTitle}`,
                    label: `${dt.PageHeader.header}`,
                  });
                }}
                className=" relative flex   px-2  group overflow-hidden false transition transform hover:-translate-y-1 duration-500 ">

                <span
                  className={`absolute rounded-lg top-0 left-0 h-full mt-1 ml-1 bg-secondary  group-hover:bg-secondary `}
                ...
                >
                  <div className=" bg-white grid-rows-2 gap-3  mr-12 text-black">
                    <div className="h-50">
                      <h3 className="my-2  header mb-5 text-gray-800">
                        {dt.PageHeader.header}
                      </h3>
        ...
        <div className=" py-8 mx-auto sm:py-10 lg:py-20 max-w-7xl">
          <div className="relative py-6 overflow-hidden  background lg:py-12 md:px-6 lg:p-16 lg:flex lg:items-center lg:justify-between md:shadow-xl md:bg-purple-1000">
            ...
            <div className="relative flex flex-col items-center w-full px-6 space-y-5 md:space-x-5 md:space-y-0 md:flex-row md:w-auto lg:flex-shrink-0 md:px-0">
              <Link
                href={data.ctacard.PrimaryCTA.linkURL}
                passHref
                onClick={() => {
                  onClick({
                    stream_score: resolve_stream_score("none"),
              ...
              <Link
                href={data.ctacard.SecondaryCTA.linkURL}
                passHref
                onClick={() => {
                  onClick({
                    stream_score: resolve_stream_score("none"),
