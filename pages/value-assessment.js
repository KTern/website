...
export default function ValueAssesment({ h_data, f_data }) {
  ...
  const renderView = ({ index, active, transitionState }) => {
    ...
    switch (data.type) {
      case "text":
        return ( <div className=" text-white flex flex-col events   items-center justify-center "  >
  ...
  return (
    ...
    <Layout h_data={h_data} f_data={f_data}>
      <div
        ...
        style={{ height: "100vh" }}
      >
       {keyValue<question.length && <ViewSlider className="mx-auto text-white flex flex-col items-center justify-center "
...
{keyValue>=question.length && <div className="text-white text-2xl">Hello</div>}
