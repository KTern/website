        ...
        <section className="xl:px-20">
          <div className="p-4 md:p-24 flex flex-wrap mx-auto">
            <div className="flex flex-col w-full  mb-5 md:w-1/2 md:mb-0">
              <Link
                href={data.QuickLinks[0].CTAUrl}
                className="relative shadow flex flex-col flex-auto px-5 py-8  overflow-hidden  md:px-8 group border-2 hover:border-black  bg-gray-50">
          ...
          <div className="py-5 container px-3 mx-auto">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="max-w-md mx-auto pb-10">
                ...
                <Link
                  href={data.CTASection.CTAButtonLink}
                  onClick={() => {
                    onClick({
                      stream_score: resolve_stream_score("none"),
