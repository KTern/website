            ...
            <Layout>
                ...
                <section className="pt-10 px-10 bg-white">
                    <div className="flex my-10 mx-10 ">
                        <div className="flex-row flex-wrap w-full xl:w-1/3  ">
                            <div className=" w-full lg:mx-10 group p-2 mb-4">
                                <div className="flex flex-wrap w-full ">
                                    <div className=" h-10 h-full lg:h-20 w-20 mx-4 my-auto">
                                        <Image className="w-full h-full object-cover " src="/assets/icons/projects.png" alt="" />
                                    </div>
                            ...
                            <div className=" w-full lg:mx-10 group p-2  mb-4">
                                <div className=" flex flex-wrap ">
                                    ...
                                    <div className="h-10 h-full lg:h-20 w-20 mx-4 my-auto">
                                        <Image className="w-full h-full object-cover " src="/assets/icons/process.svg" alt="" />
                                    </div>
                            ...
                            <div className=" w-full lg:mx-10 group p-2 mb-4">
                                <div className=" flex flex-wrap ">
                                    ...
                                    <div className="h-10 h-full lg:h-20 w-20 mx-4 my-auto ">
                                        <Image className="w-full h-full object-cover " src="/assets/icons/labs.png" alt="" />
                                    </div>
                            ...
                            <div className=" w-full lg:mx-10 group p-2 mb-4">
                                <div className=" flex flex-wrap ">
                                    ...
                                    <div className="h-10 h-full lg:h-20 w-20 mx-4 my-auto">
                                        <Image className="w-full h-full object-cover " src="/assets/icons/maps.png" alt="" />
                                    </div>
                            ...
                            <div className=" w-full lg:mx-10  group p-2 mb-4">
                                <div className=" flex flex-wrap ">
                                    ...
                                    <div className="h-full lg:h-20 w-20 mx-4 my-auto">
                                        <Image className="w-full h-full object-cover " src="/assets/icons/mines.png" alt="" />
                                    </div>
                        ...
                        <Image className="hidden xl:block my-auto h-full w-2/3" src="/assets/right-stream.svg" alt="" />
                    </div>
                </section>
                {/* <!-- /Streams Section --> */}
                ...
                <section className="xl:px-20">
                    <div className="p-4 md:p-24 flex flex-wrap mx-auto">
                        <div className="flex flex-col w-full  mb-5 md:w-1/2 md:mb-0">
                            <Link className="relative shadow flex flex-col flex-auto px-5 py-8  overflow-hidden  md:px-8 group border-2 hover:border-black  bg-gray-50" href="/pricing">
                                <div className="-ml-5 md:-ml-8">
                                    <div style={{ width: "240px" }}>
                                        <div className="Image__GatsbyObjectFitWrapper-sc-11886c9-0 gjizgk max-w-[200px] mx-0 mr-auto md:max-w-none transform transition-transform group-hover:scale-105 duration-700  mx-auto w-full">
                                            <Image className="mr-auto" src="https://a.storyblok.com/f/111801/x/a0151334d0/pricing.svg" alt="Pricing" draggable="false" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="p-1 md:px-8 space-y-5 flex flex-col w-full  md:w-1/2">
                            <Link className="relative shadow flex flex-auto p-5  group overflow-hidden md:p-8 false border-2 hover:border-black" href="">
                                <div className="relative flex flex-col justify-between flex-1 mr-12 text-black">
                                    ...
                                    <div className="mt-20">
                                        <div className="icon-link transition-opacity duration-200 group-hover:opacity-50 icon-link--black">
                                            <button to="#" className="icon-link__link">
                                                <div className="icon-link__label">
                                                    <span className="font-bold tiny-heading">Learn more</span>
                                                </div>
                                ...
                                <div className="flex flex-col items-end -mr-4 justify-end md:hidden lg:flex w-6/12 mt-auto false ">
                                    <div className="Image__GatsbyObjectFitWrapper-sc-11886c9-0 gjizgk transition-transform duration-700 transform group-hover:scale-105  mx-auto w-full">
                                        <Image className="object-contain w-full ml-auto max-h-[150px] max-w-[150px] md:max-w-[250px] md:max-h-[250px] -mr-4" src="https://a.storyblok.com/f/111801/x/ea0d65cc0b/features.svg" alt="Features" draggable="false" />
                                    </div>
                                </div>
                            </Link>
                            <Link className="relative shadow flex flex-auto p-5  group overflow-hidden md:p-8 false border-2 hover:border-black" href="/resources">
                                <div className="relative flex flex-col justify-between flex-1 mr-12 text-black">
                                    <div>
                                ...
                                <div className="flex flex-col items-end -mr-4 justify-end md:hidden lg:flex w-6/12 mt-auto false ">
                                    <div className="Image__GatsbyObjectFitWrapper-sc-11886c9-0 gjizgk transition-transform duration-700 transform group-hover:scale-105  mx-auto w-full">
                                        <Image className="object-contain w-full h-auto ml-auto max-h-[150px] max-w-[150px] md:max-w-[250px] md:max-h-[250px] -mr-4" src="https://a.storyblok.com/f/111801/x/c0b79e9d11/integrations.svg" draggable="false" />
                                    </div>
                                </div>
                            </Link>
                        </div>
                        ...
                        <div className="flex flex-wrap justify-center items-center">
                            <div className="p-6 w-full md:w-1/2 lg:w-1/4  md:mb-8 mt-8 justify-center items-center ">
                                <span className="flex items-center justify-center w-14 h-14 mb-8  rounded-full">
                                    <Image src="https://static.thenounproject.com/png/925249-200.png" alt="" />
                                </span>
                            ...
                            <div className="p-6 w-full md:w-1/2 lg:w-1/4  md:mb-8 md:mt-8 justify-center items-center ">
                                <span className="flex items-center justify-center w-14 h-14 mb-8 rounded-full">
                                    <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPlFtvMeuE65QVk7aARCnGZ6IrKur4L5D8cVk4gJCwkCGw6NbYt59RknTDlUe40zsIISA&usqp=CAU" alt="" />
                                </span>
                            ...
                            <div className="p-6 w-full md:w-1/2 lg:w-1/4  md:mb-8 md:mt-8 justify-center items-center ">
                                <span className="flex items-center justify-center w-14 h-14 mb-8 rounded-full">
                                    <Image src="https://cdn0.iconfinder.com/data/icons/business-and-finance-9-3/68/438-512.png" alt="" />
                                </span>
                            ...
                            <div className="p-6 w-full md:w-1/2 lg:w-1/4  md:mb-8 md:mt-8 justify-center items-center">
                                <span className="flex items-center justify-center w-14 h-14 mb-8 rounded-full">
                                    <Image src="/assets/cloud.png" alt="" />
                                </span>
                ...
                <section className="relative py-5 2xl:py-5 bg-gray-700 overflow-hidden" style={{ backgroundColor: '#EAEDF2' }}>
                    ...
                    <Image className="block absolute bottom-0 left-0 h-24 md:h-32 lg:h-72 lg:ml-24 -mb-8" src="/assets/five-stars.svg" alt="" />
