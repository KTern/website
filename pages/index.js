            ...
            <Layout>
                ...
                <section className=" pt-20  relative overflow-hidden bg-white">
                    ...
                    <div className=" bg-white  h-full" >
                        ...
                        <div className="xl:pb-80  bg-contain bg-no-repeat bg-bottom text-center xl:bg-hero bg-50% " >
                            ...
                            <Link   rel="noopener noreferrer" href="https://app.ktern.com"><a target="_blank" className="mb-4 inline-block mx-5   shadow-md py-3 px-14 bg-white-500  hover:bg-gray-300   text-black   rounded-l-xl rounded-t-xl transition duration-200 uppercase header button border-2">Free Trial</a></Link>
              ...
              <section className="relative items-center overflow-hidden w-full py-12 bg-white sm:py-16 md:py-20">
                    ...
                    <div className="px-10 mx-auto text-left max-w-7xl md:text-center pb-14 xl:px-0">
                        <h2 className="mx-auto section-heading  ">KTern.AI Digital Streams</h2>
