  ...
  return <>
    ...
    <Layout h_data={h_data} f_data={f_data}>
      <section className="pt-24 bg-white space-y-10 mx-4 md:mx-52 flex-col text-center justify-center items-center">
        ...
        <p className=" text-gray-700 subheading ">
              ...
              (<Link
                ...
                onClick={() => {
                  onClick({
                    ...
                    section_name: "Latest News Section",
...
export const getServerSideProps = async (ctx) => {
  ...
  const res = await fetch(
    `https://strapi.ktern.com/news-center-pages?slug=${ctx.params.news}`,
    {
      method: "get",
    }
  );
  ...
  const news = await fetch(
    `https://strapi.ktern.com/news-center-pages?_sort=updatedAt:desc&slug_nin=${ctx.params.news}&_limit=4`
  );
