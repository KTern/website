      ...
      <section className="w-full py-28 background">
        ...
        <div className="flex flex-col items-center px-12 mx-auto lg:flex-row">
          <div className="relative z-20 flex flex-col  w-full h-full ">
            <h1 className="heading text-white mb-5 text-center">
              {data.PageHeader}
            </h1>
          </div>
        </div>
        ...
        <div className="md:px-2 md:py-8 mx-auto sm:py-10  lg:py-20 max-w-7xl">
          ...
          >
            ...
            <div className="relative w-1/3 flex flex-col items-center w-full px-6 space-y-5 md:space-x-5 md:space-y-0 md:flex-row md:w-auto lg:flex-shrink-0 md:px-0">
              <Link
                href={data.CTASection.PrimaryCTA.linkURL}
                passHref
                target="_blank"
                onClick={() => {
                  onClick({
              ...
              <Link
                ...
                href={data.CTASection.SecondaryCTA.linkURL}
                passHref
                onClick={() => {
                  onClick({
                    stream_score: resolve_stream_score("none"),
...
export const getStaticProps = async () => {
  //    fetch strapi data
  const res = await fetch(`https://strapi.ktern.com/news-center`, {
    method: "get",
  });
