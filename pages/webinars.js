    ...
    <Layout h_data={h_data} f_data={f_data}> 
        ...
        <div className=" mx-auto md:py-4">
            ...
            <div className="flex flex-row items-center justify-center md:mx-auto space-x-5 md:max-w-6xl">
                ...
                <div className="w-1/2 relative flex items-center md:w-1/2  h-auto sm:px-4 py-5 md:mx-auto overflow-hidden    via-transparent">
                    {/* <!-- Slide Page 1 --> */}
                    <div className="flex md:px-2 md:space-x-10 transition w-full duration-500 ease-out  xl:pl-6 h-94" >
                        {/* <!-- story 1 --> */}
                                    ...
                                    <div className="flex-shrink-0 mb-10">
                                        <div className={`mt-4 mx-4 z-20  border border-white ${data.FeaturedWebinar.tagClass}  uppercase hyperlink absolute top:0   flex items-center px-3 py-1.5 leading-none w-auto inline-block rounded-md   uppercase text-black inline-block opactiy-60`}>
                            ...
                            <Image width="30%" height="30%" className=" w-full shadow-sm max-h-20 mr-10" src="/webinar/calendar.png" alt="Calendar"/><time className="ml-2 hyperlink text-black">{formattedDate}</time>
                                                                </div>
                                                               <div className="block mt-14  h-10 mr-4 relative left-0 flex items-center">
                            <Image width="30%" height="30%" className=" w-full shadow-sm max-h-20 mr-10" src="/webinar/clock.png" alt="Calendar"/><time className="ml-2 hyperlink text-black">{time}&nbsp;{data.FeaturedWebinar.TimeZone}</time>
                                                                </div>
                                                          </div>
    ...
    <div key="data"   className="relative flex  px-2  group overflow-hidden false transition transform hover:-translate-y-1 duration-500" >
        ...
        {/* <!-- Footer--> */}
           <section className="bg-white">
                ...
                <div className={`relative py-6 overflow-hidden  lg:py-12 md:px-6 lg:p-16 lg:flex lg:items-center lg:justify-between md:shadow-xl md:bg-purple-1000 background`}>
                ...
                <Link  href={data.CTA.PrimaryCTA.linkURL} passHref><a className=" border-2 border-white inline-block py-3 px-10 bg-black hover:bg-gray-300 hover:text-black shadow  button  text-white rounded-r-xl rounded-b-xl transition duration-200 border-2 border-black">{data.CTA.PrimaryCTA.buttonTitle}</a></Link>
