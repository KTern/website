...
<SocialProfileJsonLd
    ...
    <Layout h_data={h_data} f_data={f_data}> 
        ...
        <div className=" mx-auto md:py-4">
            ...
            <div className="flex flex-row items-center justify-center md:mx-auto space-x-5 md:max-w-7xl">
                <div className="relative flex flex-col items-start justify-center w-full h-full  px-6 mx-auto xl:max-w-none ">
                    ...
                    <div className="flex md:px-2 md:space-x-10 transition w-full duration-500 ease-out  xl:pl-6 h-94" >
                        {/* <!-- story 1 --> */}
                                    ...
                                    <div className="flex-shrink-0">
                                        <div className={`mt-4 mx-4 z-20 ${data.FeaturedWebinar.tagClass}  uppercase hyperlink absolute top:0   flex items-center px-3 py-1.5 leading-none w-auto inline-block rounded-md   uppercase text-black inline-block opactiy-60`}>
