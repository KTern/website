...
const Ebook_Landing = ({data}) => {
    return (
        ...
        <Layout>
      <section  className="w-full pt-10 bg-herogradient" >
...
export const getStaticPaths = async () => {
    ...
    const data=[{ebook:'definitive-guebooke-sap-s4hana-assessment'},{ebook:'sap-custom-code-migration-guide'},{ebook:'sap-s4hana-testing-guide'},{ebook:'manage-digital-transformation-effectively'},{ebook:'unlocking-digital-transformation-guide'}]
    // console.log(data)
