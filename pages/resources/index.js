          ...
          <div className='flex flex-wrap md:-mx-4 -mb-4 md:mb-0 px-2 md:px-10'>
            ...
            <div className='w-full md:w-4/5 md:pl-20 mb-4 md:mb-0  mt-10'>
              ...
              <section className='pb-10 '>
                <Link href='/resources#ebooks'>
                  <a className='hyperlink click-chip outline-green mr-3'>E-books</a>
                </Link>
                <Link href='/resources#white-papers'>
                  <a className=' hyperlink click-chip outline-green mr-3'>White paper</a>
                </Link>
                <Link href='/resources#customer-success-stories'>
                  <a className=' hyperlink click-chip outline-green mr-3'>Customer Success Story</a>
                </Link>
                <Link href='/resources#infographics'>
                  <a className=' hyperlink click-chip outline-green mr-3'>Infographics</a>
                </Link>
                <Link href='/resources#datasheets'>
                  <a className=' hyperlink click-chip outline-green mr-3'>Datasheets</a>
                </Link>
                <Link href='/resources#product-tours'>
                  <a className=' hyperlink click-chip outline-green mr-3'>Product tour</a>
                </Link>
                <Link href='/resources#analyst-reports'>
                  <a className=' hyperlink click-chip outline-green mr-3'>Analyst Report</a>
                </Link>
                <Link href='/resources#best-practice-guides'>
                  <a className=' hyperlink click-chip outline-green mr-3'>Best Practice guides</a>
                </Link>
                <Link href='/resources#presentations'>
                  <a className=' hyperlink click-chip outline-green mr-3'>Presentations</a>
                </Link>
              </section>
            ...
            <div className='relative py-6 overflow-hidden  bg-gradient-to-r from-black to-secondary lg:py-12 md:px-6 lg:p-16 lg:flex lg:items-center lg:justify-between md:shadow-xl md:bg-purple-1000'>
              ...
              <div className='relative p-6  md:p-0 md:pb-4'>
                ...
                <p className='w-full mt-5 card-subheading text-white '>
                  Start your 15-day free trial. No credit card required. No strings attached.
                </p>
              </div>
              <div className='relative flex flex-col items-center w-full px-6 space-y-5 md:space-x-5 md:space-y-0 md:flex-row md:w-auto lg:flex-shrink-0 md:px-0'>
                ...
                <Link rel='noopener noreferrer' href='https://app.ktern.com' passHref>
                  <a
                    target='_blank'
