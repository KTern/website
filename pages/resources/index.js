          ...
          <section className="w-full py-20 bg-secondary">
            <div className="flex flex-col items-center px-12 mx-auto max-w-7xl lg:flex-row">
                ...
                <div className="relative z-10 w-full h-full my-16 lg:my-0 lg:w-7/12">
                    <Image className="relative z-40 w-full h-full" src="https://cdn.devdojo.com/images/june2021/home-hero.png" alt="home hero"/>
                    ...
                    <div className="w-full md:w-4/5 pl-20 mb-4 md:mb-0">
                        ...
                        <div className="container mx-auto space-y-10">
                            <div className="grid grid-cols-12 col-span-12 gap-7">
                                <Link href="/resources/landing" className="flex flex-col items-start col-span-12 overflow-hidden shadow border rounded-xl md:col-span-6 lg:col-span-4">
                                    ...
                                    <div className="block transition duration-200 ease-out transform hover:scale-110">
                                        <Image className="object-cover w-full shadow-sm max-h-56" src="assets/icons/articles.png"/>
                                    </div>
                            ...
                            <hr/>
                            <div className="grid grid-cols-12 col-span-12 gap-7">
                                <Link href="/resources/landing" className="flex flex-col items-start col-span-12 overflow-hidden border shadow-sm rounded-xl md:col-span-6 lg:col-span-4">
                                    <div className="z-20 bg-primary text-white absolute top:0 mx-4 mt-5 flex items-center px-3 py-1.5 leading-none w-auto inline-block rounded-full text-xs font-medium uppercase text-black inline-block">
                                        <span>Digital Maps</span>
                                    </div>
                                    <div  className="block transition duration-200 ease-out transform hover:scale-110">
