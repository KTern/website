        ...
        <section className="w-full py-20 bg-secondary" >
            ...
            <Image width={500} height={400} alt="hero" src="/resources/metus.jpeg" className="object-cover w-full h-full transform translate-x-0 md:translate-x-0" />
                    ...
                    <div className="w-full mb-10  ">
                        <div className="relative h-full ml-5 mr-0 sm:mr-10">
                            ...
                            <div className="flex items-center -mt-1">
                                 <h3 className="my-2 ml-0 hyperlink  text-gray-800 uppercase">KTern&apos;s Value</h3>
                ...
                <div className="py-2 px-5 mb-4 bg-gray-100 rounded-lg overflow-hidden hover:bg-gray-300 hover:shadow-md">
                                        ...
                                        <div className="flex items-center" >
                                            ...
                                            <p className="hyperlink text-black hover:underline hover:shadow-sm ">Digital Maps</p>
                                        </div>
                                        </a>
                                        </Link>
                                        </div>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <p className="hyperlink  text-black hover:underline hover:shadow-sm">Digital Labs</p>
                                        </div>
                                        </a>
                                        </Link>
                                        </div>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <p className="hyperlink  text-black hover:shadow-sm hover:underline">Digital Projects</p>
                                        </div>
                                        </a>
                                        </Link>
                                        </div>
                    ...
                    <div className="w-full mb-10  ">
                        <div className="relative h-full ml-5 mr-0 sm:mr-10">
                            ...
                            <div className="relative h-full p-5 bg-white border-2 border-black rounded-lg">
                                <div className="flex items-center -mt-1">
                                 <h3 className="my-2 ml-0 hyperlink  text-gray-800 uppercase">Industry</h3>
                                 
                                </div>
                                <p className="mt-0 mb-1 hyperlink  text-gray-800">HVAC space</p>
                                <div className="flex items-center -mt-1">
                                 <h3 className="my-2 ml-0  hyperlink text-gray-800 uppercase">Headquarters</h3>
                                 
                                </div>
                                <p className="mt-0 mb-1  hyperlink text-gray-800">USA</p>
                            </div>
                    ...
                    <div className="w-full mb-10  ">
                        <div className="relative h-full ml-5 mr-0 sm:mr-10">
                            ...
                            <div className="relative h-full p-5 bg-white border-2 border-black rounded-lg">
                                <div className="flex items-center -mt-1">
                                 <h3 className="my-2 ml-0 hyperlink  text-gray-800 uppercase">Challenges</h3>
                                 
                                </div>
                               

                                <ul className="list-disc ml-4 hyperlink  text-black lg:">
                            <li className="pb-2 hyperlink" >Massive growth in the recent years making their current ECC processes obsolete</li>
                           <li className="pb-2 hyperlink">Multiple interfaces without seamless integration</li>
                           <li className="pb-4 hyperlink">No real-time data availability</li>
                           </ul>
                            </div>
                    ...
                    <div className="w-full mb-10  ">
                        <div className="relative h-full ml-5 mr-0 sm:mr-10">
                            ...
                            <div className="relative h-full p-5 bg-white border-2 border-black rounded-lg">
                                <div className="flex items-center -mt-1">
                                 <h3 className="my-2 ml-0 hyperlink  text-gray-800 uppercase">Solution</h3>
                                 
                                </div>
                               

                                <ul className="list-disc ml-4 hyperlink  text-black lg:">
                            <li className="pb-2 hyperlink" >Identified and determined a roadmap from ECC to S/4HANA</li>
                           <li className="pb-2 hyperlink">Assess the existing processes and identify pain points and improvement opportunities enabled through S/4HANA</li>
                           <li className="pb-4 hyperlink">Identify all the necessary pre-requisites for the SAP S/4HANA transformation</li>
                           </ul>
                            </div>
            ...
            <div className="max-w-xs col-span-4 font-sans border-0 border-gray-200 text-gray-50">
                <div className="box-border flex flex-col items-center h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:items-start sm:text-left">
                    ...
                    <div className="mt-6 font-sans text-center border-0 border-gray-200 sm:text-left text-gray-50">
                        <span className="box-border hyperlink  leading-none tracking-wider border-solid text-black">360 degree Automation</span>
            ...
            <div className="max-w-xs col-span-4 font-sans border-0 border-gray-200 text-gray-50">
                ...
                <svg id="Capa_1" className="w-10 h-10" enableBackground="new 0 0 443.294 443.294" viewBox="0 0 443.294 443.294" xmlns="http://www.w3.org/2000/svg"><path d="m221.647 0c-122.214 0-221.647 99.433-221.647 221.647s99.433 221.647 221.647 221.647 221.647-99.433 221.647-221.647-99.433-221.647-221.647-221.647zm0 415.588c-106.941 0-193.941-87-193.941-193.941s87-193.941 193.941-193.941 193.941 87 193.941 193.941-87 193.941-193.941 193.941z"/><path d="m235.5 83.118h-27.706v144.265l87.176 87.176 19.589-19.589-79.059-79.059z"/></svg>
                     ...
                     <div className="mt-6 font-sans text-center border-0 border-gray-200 sm:text-left text-gray-50">
                        <span className="box-border hyperlink  leading-none tracking-wider border-solid text-black">20+ Hours Saved</span>
...
<svg className="w-10 h-10" viewBox="-29 0 487 487.71902" width="487pt" xmlns="http://www.w3.org/2000/svg"><path d="m220.867188 266.175781c-.902344-.195312-1.828126-.230469-2.742188-.09375-9.160156-1.066406-16.070312-8.816406-16.085938-18.035156 0-4.417969-3.582031-8-8-8-4.417968 0-8 3.582031-8 8 .023438 15.394531 10.320313 28.878906 25.164063 32.953125v8c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-7.515625c17.132813-3.585937 28.777344-19.542969 26.976563-36.953125-1.804688-17.410156-16.472657-30.640625-33.976563-30.644531-10.03125 0-18.164063-8.132813-18.164063-18.164063s8.132813-18.164062 18.164063-18.164062 18.164063 8.132812 18.164063 18.164062c0 4.417969 3.582031 8 8 8 4.417968 0 8-3.582031 8-8-.023438-16.164062-11.347657-30.105468-27.164063-33.441406v-7.28125c0-4.417969-3.582031-8-8-8s-8 3.582031-8 8v7.769531c-16.507813 4.507813-27.132813 20.535157-24.859375 37.496094s16.746094 29.621094 33.859375 29.617187c9.898437 0 17.972656 7.925782 18.152344 17.820313.183593 9.894531-7.597657 18.113281-17.488281 18.472656zm0 0"/><path d="m104.195312 222.5c0 64.070312 51.9375 116.007812 116.007813 116.007812s116.007813-51.9375 116.007813-116.007812-51.9375-116.007812-116.007813-116.007812c-64.039063.070312-115.933594 51.96875-116.007813 116.007812zm116.007813-100.007812c55.234375 0 100.007813 44.773437 100.007813 100.007812s-44.773438 100.007812-100.007813 100.007812-100.007813-44.773437-100.007813-100.007812c.0625-55.207031 