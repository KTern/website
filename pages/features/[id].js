    ...
    <div className="p-16 bg-black">
      <div className="flex flex-wrap items-center -mx-10 -mb-10">
        <div className="w-full md:w-1/2 lg:w-1/4 px-10 mb-10 text-center">
          ...
          <h3 className="mb-3   card-heading text-blue-800">2 Million</h3>
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 px-10 mb-10 text-center">
          ...
          <h3 className="mb-4   card-heading text-blue-800">500,000</h3>
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 px-10 mb-10 text-center">
          ...
          <h3 className="mb-4   card-heading text-blue-800">200,000</h3>
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 px-10 mb-10 text-center">
          ...
          <h3 className="mb-4   card-heading text-blue-800">200000</h3>
