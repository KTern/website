...
export default function Digital_Projects () {
    return (
        ...
        <Layout>
            ...
            <div className="flex flex-col px-8 mx-auto space-y-12  xl:px-12">
    ...
    <div className="box-border flex flex-col items-center px-8 py-20 mx-auto leading-6 border-solid max-w-7xl xl:px-16 md:items-stretch md:justify-center md:py-24">
        <div className="relative pb-10">
            <h2 className="w-full m-0 font-sans  font-black leading-loose tracking-wide text-center text-gray-700 border-0 border-gray-200 sm:">
                Smoother Remediation
            </h2>
            <p className="w-full max-w-xl mx-0 mx-auto mt-4 mb-0 font-sans   leading-relaxed text-center text-gray-400 border-0 border-gray-200 lg: md:">
        ...
        <div className="z-10 grid gap-5 md:grid-cols-6 lg:grid-cols-9">
            ...
            <div className="col-span-3 font-sans text-gray-700 bg-white rounded-3xl">
                <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                    ...
                    <div className="mt-4 font-sans text-left text-gray-700 border-0 border-gray-200 sm:mt-2 sm:ml-4">
                        <h6 className="box-border   leading-none tracking-wide text-left border-solid">Bulk Remediate</h6>
                        <p className="box-border mx-0 mt-1 mb-0  leading-loose text-gray-400 border-solid sm:mt-4">
            ...
            <div className="col-span-3 font-sans text-gray-700 bg-white rounded-3xl">
                <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                    ...
                    <div className="mt-4 font-sans text-left text-gray-700 border-0 border-gray-200 sm:mt-2 sm:ml-4">
                        <h6 className="box-border   leading-none tracking-wide text-left border-solid">Assign Stakeholders</h6>
                        <p className="box-border mx-0 mt-1 mb-0  leading-loose text-gray-400 border-solid sm:mt-4">
            ...
            <div className="col-span-3 font-sans text-gray-700 bg-white rounded-3xl">
                <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                    ...
                    <div className="mt-4 font-sans text-left text-gray-700 border-0 border-gray-200 sm:mt-2 sm:ml-4">
                        <h6 className="box-border   leading-none tracking-wide text-left border-solid">Code Diagnostic Checks</h6>
                        <p className="box-border mx-0 mt-1 mb-0  leading-loose text-gray-400 border-solid sm:mt-4">
            ...
            <div className="col-span-3 font-sans text-gray-700 bg-white rounded-3xl">
                <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                    ...
                    <div className="mt-4 font-sans text-left text-gray-700 border-0 border-gray-200 sm:mt-2 sm:ml-4">
                        <h6 className="box-border   leading-none tracking-wide text-left border-solid">Custom Code Dashboard</h6>
                        <p className="box-border mx-0 mt-1 mb-0  leading-loose text-gray-400 border-solid sm:mt-4">
            ...
            <div className="col-span-3 font-sans text-gray-700 bg-white rounded-3xl">
                <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                    ...
                    <div className="mt-4 font-sans text-left text-gray-700 border-0 border-gray-200 sm:mt-2 sm:ml-4">
                        <h6 className="box-border   leading-none tracking-wide text-left border-solid">Custom Code Sign-Off Wizard</h6>
                        <p className="box-border mx-0 mt-1 mb-0  leading-loose text-gray-400 border-solid sm:mt-4">
            ...
            <div className="col-span-3 font-sans text-gray-700 border-0 bg-white rounded-3xl">
                <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                    ...
                    <div className="mt-4 font-sans text-left text-gray-700 border-0 border-gray-200 sm:mt-2 sm:ml-4">
                        <h6 className="box-border   leading-none tracking-wide text-left border-solid">Project Management</h6>
                        <p className="box-border mx-0 mt-1 mb-0  leading-loose text-gray-400 border-solid sm:mt-4">
    ...
    <div className="p-16 bg-white">
      <div className="flex flex-wrap items-center -mx-10 -mb-10">
        <div className="w-full md:w-1/2 lg:w-1/4 px-10 mb-10 text-center">
          ...
          <h3 className="mb-3   font-heading text-blue-800">2 Million</h3>
          <p className=" uppercase text-gray-500">Lines of Custom code Analyzed</p>
        </div>
        <div className="w-full md:w-1/2 lg:w-1/4 px-10 mb-10 text-center">
          <span>
            <svg className="mx-auto mb-6 text-blue-800 h-8 w-8" viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <h3 className="mb-4   font-heading text-blue-800">500,000</h3>
          <p className=" uppercase text-gray-500">Custom Code recommendations</p>
        </div>
        <div className="w-full md:w-1/2 lg:w-1/4 px-10 mb-10 text-center">
          <span>
          ...
          <h3 className="mb-4   font-heading text-blue-800">200,000</h3>
          <p className=" uppercase text-gray-500">Transport Requests</p>
        </div>
        <div className="w-full md:w-1/2 lg:w-1/4 px-10 mb-10 text-center">
          <span>
          ...
          <h3 className="mb-4   font-heading text-blue-800">200000</h3>
          <p className=" uppercase text-gray-500">Man Hours Saved</p>
        </div>
      </div>
    </div>
  </div>
 ...
 <section className="py-10 bg-project-white">
                    <div className="container mx-auto w-1/2 flex-col space-y-4">
                        <h2 className="mb-2 card-heading  text-center md: mb-10">Frequently Asked Questions</h2>
            ...
            <div className="px-10 mx-auto max-w-7xl">
                ...
                <div className="grid grid-cols-12 gap-6">
                  ...
                  <div className="text-center"><Link  href="#" passHref><a className="inline-block py-4 px-12 border border-gray-200 hover:border-gray-50 hover:bg-gray-100 rounded-full  text-black"> View All</a></Link></div>
                </div>
                </section>
