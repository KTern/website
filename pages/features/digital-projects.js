        ...
        <Layout>
            ...
            <div className="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
                <div className="relative">
                    <h2 className="w-full card-heading  text-center"> Level Up Your Designs</h2>
                    <p className="w-full py-8 mx-auto -mt-2 card-subheading text-center text-gray-700  sm:max-w-3xl">Add some nice touches to your interface with our latest designs, components, and templates. We&apos;ve crafted a beautiful user experience that your visitors will love. </p>
                </div>
                <div className="flex mb-8 animated fadeIn space-x-20">
                    <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 w-1/2 sm:pr-16">
                        <p className=" tiny-subheading font-semibold  text-left text-project-primary uppercase">Drag-n-drop design</p>
                        <h3 className=" card-heading sm:text-left">Design Made Easy</h3>
                        <p className="mt-2 card-subheading text-gray-700  md:text-left">Crafting your user experience has never been easier, with our intuitive drag&apos;n drop interface you will be creating beatiful designs in no time.</p>
                    </div>
                ...
                <div className="flex space-x-20 mb-8 animated fadeIn sm:flex-row">
                    ...
                    <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 w-1/2 sm:pl-16">
                        <p className=" tiny-subheading font-semibold text-left text-project-primary uppercase">know your data</p>
                        <h3 className=" card-heading sm:text-left">Optimized For Conversions</h3>
                        <p className="mt-2 card-subheading text-gray-700">Backed by data, these templates have been crafted for ultimate optimization. Now, converting your visitors into customers is easier than ever before.</p>
                    </div>
                </div>
                 <div className="flex mb-8 animated fadeIn space-x-20">
                    <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 w-1/2 sm:pr-16">
            ...
            <section className="text-black body-font bg-project-secondary">
                <div className="px-5 py-10 mx-auto flex flex-wrap flex-col">
                    <h2 className="mb-5 card-heading  text-center">Find Information Specific to your Role</h2>
                <div className="flex w-1/2 mx-auto flex-wrap mb-5">
                            <Link href="" passHref>
                                <a className="sm:px-6 py-3 w-1/4 sm:w-auto justify-center sm:justify-start border-b-2 bg-gray-100 inline-flex items-center border-indigo-500 text-indigo-500  rounded-t">
                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5 mr-3" viewBox="0 0 24 24">
                            ...
                            <Link href="" passHref>
                                <a className="sm:px-6 py-3 w-1/4 sm:w-auto justify-center sm:justify-start border-b-2  inline-flex items-center border-gray-200 hover:text-gray-900 ">
                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5 mr-3" viewBox="0 0 24 24">
            ...
            <section className="py-5 2xl:py-10 bg-black">
                ...
                <div>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-14 mb-16 lg:mb-0">
                        ...
                        <h3 className=" mb-4 card-heading  text-white">New tools</h3>
                        <p className="card-subheading text-gray-200">The brown me quam, sagittis porttitor lorem vel, commodo fringilla.</p>
                    </div>
                    <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-14 mb-16 lg:mb-0">
                        <div className="relative flex items-center justify-center mb-10 w-20 h-20">
                        ...
                        <div className="py-px mb-2  bg-gray-400"></div>
                        <h3 className=" mb-4 card-heading   text-white">Workshops</h3>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-14 mb-16 md:mb-0">
                        ...
                        <div className="py-px mb-2 bg-gray-400"></div>
                        <h3 className="mb-4 card-heading   text-white">Meetings</h3>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-14">
                        ...
                        <div className="py-px mb-2 bg-gray-400"></div>
                        <h3 className="mb-4 card-heading   text-white">Webinars</h3>
            ...
            <section className="py-10 bg-project-secondary">
                ...
                <div className="flex flex-wrap items-center -mx-3">
                    ...
                    <div className="w-full lg:max-w-md">
                        <h2 className="mb-2 card-heading ">Jam-packed with all the tools you need to succeed!</h2>
         ...
         {/* <!-- Related Resources  --> */ }
            ...
            <div className="px-10 mx-auto max-w-7xl">
                <div className="flex items-center justify-between w-full pb-5 mb-8 border-b border-gray-200">
                    <h2 className="card-heading  ">Related Resources</h2>
                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="relative col-span-12 mb-10 space-y-4 md:col-span-6 lg:col-span-4">
                        ...
                        <p className="tiny-subheading  text-gray-400 uppercase">Resources</p>
                        <Link href="#_" passHref><a className="block card-subheading font-semibold text-gray-700 hover:text-gray-900">4 Simple Tips for Leveraging the Power of Social Media</a></Link>
                    </div>
                    ...
                    <div className="relative col-span-12 mb-10 space-y-4 md:col-span-6 lg:col-span-4">
                        ...
                        <p className="tiny-subheading  text-gray-400 uppercase">Resources</p>
                        <Link href="#_" passHref ><a className="block card-subheading  font-semibold  text-gray-700 hover:text-gray-900">The Best Tips for Creating Engaging and Compelling Photos</a></Link>
                    </div>
                    ...
                    <div className="relative col-span-12 mb-10 space-y-4 md:col-span-6 lg:col-span-4">
                        ...
                        <p className="tiny-subheading  text-gray-400 uppercase">Resources</p>
                        <Link href="#_" passHref><a className="block card-subheading  font-semibold  text-gray-700 hover:text-gray-900">How to Get the Most Engagement from your Online Resources</a></Link>
                    </div>
                </div>
                </div>
                </section>
