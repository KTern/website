...
export default function Features () {
    return (
        <Layout>
                                ...
                                <a href="#" className="w-full mb-10 sm:mb-0 sm:w-1/2   ">
                                    <div className="relative h-full ml-0 mr-0 sm:mr-10 shadow hover:shadow-xl transition-all duration-500">
                                        ...
                                        <div className="relative h-full p-5 bg-white border-2 border-yellow-500 rounded-lg">
                                            ...
                                            <span className="absolute flex items-center text-sm font-bold text-indigo-600 hover:underline bottom-1">
                                                Learn More
            ...
            <section className="relative w-full py-12 overflow-hidden bg-white md:py-20 xl:pt-32 xl:pb-40">
                <div className="container relative flex flex-col justify-between h-full max-w-6xl px-10 mx-auto xl:px-0">
                    <h2 className="mb-1 text-3xl font-extrabold leading-tight text-gray-900">Digital Processes</h2>
                    <p className="mb-12 text-lg text-gray-500">KTern’s Digital Maps connects to an ECC system and assess the entire landscape</p>
            ...
            <section className="relative w-full py-12 overflow-hidden bg-white md:py-20 xl:pt-32 xl:pb-40">
                <div className="container relative flex flex-col justify-between h-full max-w-6xl px-10 mx-auto xl:px-0">
                    <h2 className="mb-1 text-3xl font-extrabold leading-tight text-gray-900">Digital Projects</h2>
                    <p className="mb-12 text-lg text-gray-500">KTern’s Digital Maps connects to an ECC system and assess the entire landscape</p>
            ...
            <section className="relative w-full py-12 overflow-hidden bg-white md:py-20 xl:pt-32 xl:pb-40">
                <div className="container relative flex flex-col justify-between h-full max-w-6xl px-10 mx-auto xl:px-0">
                    <h2 className="mb-1 text-3xl font-extrabold leading-tight text-gray-900">Digital Labs</h2>
                    <p className="mb-12 text-lg text-gray-500">KTern’s Digital Maps connects to an ECC system and assess the entire landscape</p>
            ...
            <section className="relative w-full py-12 overflow-hidden bg-white md:py-20 xl:pt-32 xl:pb-40">
                <div className="container relative flex flex-col justify-between h-full max-w-6xl px-10 mx-auto xl:px-0">
                    <h2 className="mb-1 text-3xl font-extrabold leading-tight text-gray-900">Digital Mines</h2>
                    <p className="mb-12 text-lg text-gray-500">KTern’s Digital Maps connects to an ECC system and assess the entire landscape</p>
