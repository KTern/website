...
export default function Features () {
    return (
        <Layout>
                <section className=" py-10 flex flex-wrap  px-4 mx-auto">
        <div className="w-full md:w-1/2 lg:w-1/3 xl:1/3 px-6 lg:px-8 mb-20 lg:mb-0">
            <div className="py-20 2xl:py-40">
                <div className="container px-4 mx-auto">
                    <h3 className="mt-12 mb-8 text-lg font-bold font-heading">
                        Digital Projects
                    </h3>
                    <div className="pb-px mb-12 bg-black"></div>
                    <p className="text-lg">
                        Assess and Understand Implications in your SAP System
                    </p>
                    <div className="mt-10 icon-link transition-opacity duration-200 group-hover:opacity-50 icon-link--black">
        ...
        <div className=" w-full md:w-1/2 lg:w-2/3 xl:2/3 px-6 lg:px-8 mb-20 lg:mb-0">
            <div className="py-5 2xl:py-5">
                <div className=" px-4 mx-auto ">

                    <div className="flex flex-wrap -mx-6 lg:-mx-8  ">
                        <div className="p-10 w-full md:w-1/2 lg:w-1/2 px-6 lg:px-8 mb-5 lg:mb-5  ">
                            ...
                            <div className="pb-px  bg-gray-400"></div>
                            <h3 className=" mb-8 text-lg font-bold font-heading">
                                Backups
                            </h3>
                            <p className="text-lg">
                        ...
                        <div className="p-10 w-full md:w-1/2 lg:w-1/2 px-6 lg:px-8 mb-5 lg:mb-5  ">
                            <span className="flex mb-10 justify-center items-center w-20 h-20 bg-red-600 rounded-lg">
                                    <svg
                                    className="w-8 h-8"
                                    width="35"
                                    height="35"
                        ...
                        <div className="p-10 w-full md:w-1/2 lg:w-1/2 px-6 lg:px-8 mb-5 lg:mb-5   ">
                            ...
                            <p className="text-lg">
                                Again and again vehicula libero at nibh volutpat lacinia non sed you see.
                            </p>
                            <div className="mt-10 icon-link transition-opacity duration-200 group-hover:opacity-50 icon-link--black">
                                <button to="#" className="icon-link__link">
                               <div className="icon-link__label">
