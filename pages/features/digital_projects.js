...
export default function Digital_Projects () {
    return (
        ...
        <Layout>
            <section className="w-full py-20 bg-white" style={{backgroundImage:'url(/pattern.svg)', backgroundRepeat: 'no-repeat', backgroundPosition:' bottom' }}>
            ...
            <section className="py-5 2xl:py-10 bg-black">
                ...
                <div>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-14 mb-16 lg:mb-0">
                        ...
                        <div className="py-px mb-12 bg-gray-400"></div>
