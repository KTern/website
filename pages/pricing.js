...
//             <section class="overflow-hidden text-gray-700 bg-white" x-data="{ billing: 'Monthly', maps: {'Monthly' : '3000', 'Yearly' : '1000'}, process: {'Monthly' : '3000', 'Yearly' : '1000' }, projects: {'Monthly' : '3000', 'Yearly' : '1000' },labs: {'Monthly' : '3000', 'Yearly' : '1000'},mines: {'Monthly' : '3000', 'Yearly' : '1000'}, accronym: {'Monthly' : 'mo', 'Yearly' : 'yr' }}">
...
//                             <h1 class="text-6xl font-black text-black lg:text-6xl">Get Started With KTern.AI</h1>
//                             <p class="mx-auto text-lg leading-relaxed text-gray-500 lg:w-2/3">Digital Transformation made simple</p>
//                         </div>
...
//                                 <div class="absolute w-1/2 h-full transition-all duration-150 ease-out bg-black" :class="{ 'left-0' : billing == 'Monthly', 'left-1/2' : billing == 'Yearly' }"></div>
...
//                         <div class="w-full p-2 xl:w-1/6 md:w-1/2">
//                         <div class="relative flex flex-col justify-between h-full p-6 overflow-hidden border border-blue-600 rounded-lg">
//                             <span class="absolute top-0 right-0 px-3 py-0 text-xs tracking-widest text-white bg-blue-600 rounded-bl">Selected</span>                           
//                             <div class="flex flex-col w-full">
//                                     <h2 class="mb-1 text-sm font-medium tracking-widest uppercase">Digital Maps</h2>
//                                     <h1 class="flex items-center pb-4 mb-4 text-4xl leading-none text-gray-900 border-b border-gray-200"><span>$<span x-text="maps[billing]"></span></span><span class="ml-1 text-lg font-normal text-gray-500">/<span x-text="accronym[billing]"></span></span></h1>
...
//                                         View Details
//                                         <img src="down-arrow-svgrepo-com.svg" class="w-4 h-4 ml-2" />
//                                     </button>
...
//                         <div class="w-full p-2 xl:w-1/6 md:w-1/2">
//                         <div class="relative flex flex-col justify-between h-full p-6 overflow-hidden border border-blue-600 rounded-lg">
//                             <span class="absolute top-0 right-0 px-3 py-0 text-xs tracking-widest text-white bg-blue-600 rounded-bl">Selected</span>                            <div class="flex flex-col w-full">
//                                     <h2 class="mb-1 text-sm font-medium tracking-widest uppercase">Digital Maps</h2>
//                                     <h1 class="flex items-center pb-4 mb-4 text-4xl leading-none text-gray-900 border-b border-gray-200"><span>$<span x-text="maps[billing]"></span></span><span class="ml-1 text-lg font-normal text-gray-500">/<span x-text="accronym[billing]"></span></span></h1>
//                                     <p class="flex items-center mb-2 text-gray-600"><span class="inline-flex items-center justify-center flex-shrink-0 w-4 h-4 mr-2 text-white bg-gray-500 rounded-full"><svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" class="w-3 h-3" viewBox="0 0 24 24">
//                                                 <path d="M20 6L9 17l-5-5"></path>
...
//                         <div class="relative flex flex-col justify-between h-full p-6 overflow-hidden border border-gray-600 bg-gray-100 rounded-lg">

//                             <div class="flex flex-col w-full">
//                                 <h2 class="mb-1 text-sm font-extrabold tracking-widest uppercase">Overall</h2>
//                                 <h1 class="flex items-center pb-4 mb-4 text-3xl leading-none text-gray-900 border-b border-gray-200"><span>$10000</span><span class="ml-1 text-lg font-normal text-gray-500">/<span x-text="accronym[billing]"></span></span></h1>
                                
//                                         <div class="py-2 px-5 mb-4 bg-white rounded-lg overflow-hidden">
//                                         <div class="flex items-center">
//                                             <span class="flex items-center justify-center w-8 h-8 mr-8 bg-transparent rounded-lg">
//                                             <img src="Maps.png">
//                                             </span>
//                                             <p class="text-xs font-bold text-black">Digital Maps</p>
//                                         </div>
//                                         </div>
...
//                                             <img src="Process.png">
//                                             </span>
//                                             <p class="text-xs font-bold text-black">Digital Process</p>
//                                         </div>
//                                         </div>
...
//                                             </span>
//                                             <p class="text-xs font-bold text-black">Digital Projects</p>
//                                         </div>
//                                         </div>
//                                         <div class="py-2 px-5 mb-4 bg-white rounded-lg overflow-hidden">
//                                         <div class="flex items-center">
...
//                                             <img src="Labs.png">
//                                             </span>
//                                             <p class="text-xs font-bold text-black">Digital Labs</p>
//                                         </div>
//                                         </div>
//                                         <div class="py-2 px-5 mb-4 bg-white rounded-lg overflow-hidden">
//                                         <div class="flex items-center">
...
//                                             <img src="Mines.png">
//                                             </span>
//                                             <p class="text-xs font-bold text-black">Digital Mines</p>
...
//             <section class="pt-8 pb-16 sm:pt-10 sm:pb-20 md:pt-12 md:pb-24" style="background-color:#f5f6f7">
...
//                         <h2 class="text-4xl font-bold text-transparent sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-heading bg-clip-text bg-gradient-to-br from-black via-gray-750 to-white">
...
//                 <h2 class="mb-24 text-center text-5xl font-bold font-heading text-white">Case Studies</h2>
//                 <div class="flex flex-wrap justify-center -mx-10 mb-20">
//                     <div class="w-full lg:w-1/3 px-10 mb-20 lg:mb-0">
//                     <div>
//                         <img class="mb-8 w-full h-112 lg:h-80 object-cover object-top" src="mitsubishi.png" alt="">
//                         <a class="inline-block w-full p-10 bg-white hover:bg-gray-100 rounded-lg transition duration-200" href="#">
//                         <h3 class="mb-2 text-2xl text-black font-bold font-heading">70% SAP Cost Saved</h3>
//                         <p class="mb-4 text-xs text-black font-bold">SAP ERP Transformation</p>
...
//                     <div class="w-full lg:w-1/3 px-10 mb-20 lg:mb-0">
//                     <div class="lg:mt-24">
//                         <img class="mb-8 w-full h-112 lg:h-80 object-cover object-top" src="asmnew.png" alt="">
//                         <a class="inline-block w-full p-10 bg-white hover:bg-gray-100 rounded-lg transition duration-200" href="#">
//                         <h3 class="mb-2 text-2xl text-gray-600 font-bold font-heading">30% Automated Results</h3>
//                         <p class="mb-4 text-xs text-black font-bold">SAP Assessment</p>
//                         <div class="flex justify-end">
//                             <svg width="27" height="15" viewBox="0 0 27 15" fill="none" xmlns="http://www.w3.org/2000/svg">
//                             <path d="M26.2042 7.78599L19.5171 14.4731L18.6812 13.6372L24.3611 7.95734L0.709572 7.96153L0.709572 6.78292L24.3611 6.77874L19.0992 1.51681L19.9351 0.680916L26.2042 6.9501C26.4351 7.18093 26.4351 7.55515 26.2042 7.78599Z" fill="black"></path>
//                             </svg>
...
//                     <div>
//                         <img class="mb-8 w-full h-112 lg:h-80 object-cover object-top" src="aramconew.png" alt="">
//                         <a class="inline-block w-full p-10 bg-white hover:bg-gray-100 rounded-lg transition duration-200" href="#">
//                         <h3 class="mb-2 text-2xl text-black font-bold font-heading">20% Automated Testing</h3>
//                         <p class="mb-4 text-xs text-gray-600 font-bold">SAP Testing</p>
//                         <div class="flex justify-end">
//                             <svg width="27" height="15" viewBox="0 0 27 15" fill="none" xmlns="http://www.w3.org/2000/svg">
//                             <path d="M26.2042 7.78599L19.5171 14.4731L18.6812 13.6372L24.3611 7.95734L0.709572 7.96153L0.709572 6.78292L24.3611 6.77874L19.0992 1.51681L19.9351 0.680916L26.2042 6.9501C26.4351 7.18093 26.4351 7.55515 26.2042 7.78599Z" fill="black"></path>
//                             </svg>
...
//                     </div>
//                 </div>
//                 <div class="text-center"><a class="inline-block py-4 px-12 border border-gray-200 hover:border-gray-50 rounded-full font-bold text-white" href="#"> All Case Studies</a></div>
//                 </div>
//             </div>
//             </section>
//             <!-- Detailed Tabular Column Section-->
//             <section class="relative py-20 2xl:py-40" style=background-color:#f5f6f7>
//                 <div class="container px-4 pb-20 mx-auto border-b border-gray-100">
//                 <div class="mb-14 text-center">
//                     <span class="text-lg text-Black font-bold">Detailed Pricing</span>
//                     <h2 class="mt-8 text-5xl font-bold text-gray-300 font-heading">See all features</h2>
//                 </div>
//                 <div class="pt-20 border-t border-gray-100 ">
//                     <table class="table-auto w-full mb-10">
//                     <thead>
//                         <tr class="text-lg text-left font-bold ">
//                             <th class="sticky top-0 pb-20"> 
                            
//                                 </th>
//                             <th class=" sticky top-0 pb-6 pr-8 bg-gray-100">
//                                 <div class="top-0 absolute w-full h-2 bg-gradient-to-r from-black to-white"></div>
//                                 <div>
//                                 <div class="flex items-center justify-between text-gray-200 py-10">
                
//                                     <div class="relative justif-self-end mr-2 ">
//                                         <h2 class="text-lg font-black text-black">Digital</h2>
//                                         <p class="text-xs font-medium text-black uppercase">Maps</p>
//                                     </div>
//                                     <div class="flex items-center">
//                                         <h3 class="text-3xl text-black">$3000</h3>
...
//                                     <button class="inline-flex items-center justify-center  px-4 py-2  text-xs font-medium  text-gray-600 whitespace-no-wrap bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:shadow-none">
//                                         Contact Sales
//                                         <img src="down-arrow-svgrepo-com.svg" class="w-4 h-4 ml-2" />
//                                     </button>
...
//                                     <div class="relative justif-self-end mr-2">
//                                         <h2 class="text-lg font-black text-black">Digital</h2>
//                                         <p class="text-xs font-medium text-black uppercase">Processes</p>
//                                     </div>
//                                     <div class="flex items-center">
//                                         <h3 class="text-3xl text-black">$3000</h3>
...
//                                 </div>
//                             </th>
//                             <th class="sticky top-0 pb-6 pr-8 bg-gray-100"> <div class="top-0 absolute w-full h-2 bg-gradient-to-r from-black to-white"></div>
//                                 <div>
//                                 <div class="flex items-center justify-between text-gray-200">
                
//                                     <div class="relative justif-self-end mr-2">
//                                         <h2 class="text-lg font-black text-black">Digital</h2>
//                                         <p class="text-xs font-medium text-black uppercase">Projects</p>
//                                     </div>
//                                     <div class="flex items-center">
//                                         <h3 class="text-3xl text-black">$3000</h3>
...
//                                     <div class="relative justif-self-end mr-2">
//                                         <h2 class="text-lg font-black text-black">Digital</h2>
//                                         <p class="text-xs font-medium text-black uppercase">Labs</p>
//                                     </div>
//                                     <div class="flex items-center">
//                                         <h3 class="text-3xl text-black">$3000</h3>
...
//                                     <div class="relative justif-self-end mr-2">
//                                         <h2 class="text-lg font-black text-black">Digital</h2>
//                                         <p class="text-xs font-medium text-black uppercase">Mines</p>
//                                     </div>
//                                     <div class="flex items-center">
//                                         <h3 class="text-3xl text-black">$3000</h3>
...
//                         </tr>
//                     </thead>
//                     <tbody class="overflow-x-auto overflow-y-hidden">
//                         <tr class="text-xl bg-gray-50">
//                         <td class="py-5 pl-10 text-left">Number of Team Members</td>
//                         <td>5</td>
//                         <td>20</td>
//                         <td>200+</td>
//                         <td>Unlimited</td>
...
//                         </tr>
//                         <tr class="text-xl">
//                         <td class="py-5 pl-10 text-left">Users</td>
//                         <td>3</td>
//                         <td>10</td>
//                         <td>50+</td>
//                         <td>100+</td>
...
//                         </tr>
//                         <tr class="text-xl bg-gray-50">
//                         <td class="py-5 pl-10 text-left">Projects</td>
//                         <td>3/mo</td>
//                         <td>Unlimited</td>
//                         <td>Unlimited</td>
//                         <td>Unlimited</td>
...
//                         </tr>
//                         <tr class="text-xl">
//                         <td class="py-5 pl-10 text-left">Video chat</td>
//                         <td>
...
//                         </tr>
//                         <tr class="text-xl bg-gray-50">
//                         <td class="py-5 pl-10 text-left">Realt-Time Collaboration</td>
//                         <td>
...
//                         </tr>
//                         <tr class="text-xl">
//                         <td class="py-5 pl-10 text-left">Support</td>
//                         <td>
//                             <svg width="16" height="2" viewBox="0 0 16 2" fill="none" xmlns="http://www.w3.org/2000/svg"><line y1="1.35" x2="16" y2="1.35" stroke="#1F40FF" stroke-width="1.3"></line></svg>
//                         </td>
//                         <td>
...
//                         <p class="mr-6 text-5xl font-bold text-black">
//                         8%
                        
//                         </p>
//                         <p class="text-lg">The tell condimentum turpis lorem</p>
//                     </div>
//                     <div class="max-w-xs flex items-center">
//                         <p class="mr-6 text-5xl font-bold text-black">20</p>
//                         <p class="text-lg">A sad laoreet sit amet nec purus</p>
//                     </div>
//                     </div>
//                 </div>
//                 </div>
