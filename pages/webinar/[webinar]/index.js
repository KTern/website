          ...
          <div className=" mx-auto">
            <div className="flex flex-col items-start md:flex-row">
              <div className="w-full space-y-5 md:w-3/5 md:pr-16">
                ...
                >
                  <Link
                    href={`/digital-${webinar_Data.CssStreamTag}`}
                    rel="category"
                    passHref
                  >
                    <a
                      onClick={() => {
                        onClick({
                          stream_score: resolve_stream_score(
                            webinar_Data.CssStreamTag
                          ),
                          event_name: "Link Click",
                          section_name: "Webinar Content Section",
                          page_source: `${webinar_Data.PageSEO.PageTitle}`,
                          label: `${webinar_Data.DigitalStream}`,
                        });
                      }}
                  ...
                  options={{
                    overrides: {
                      ...
                      p: {
                        props: {
                          className:
                            "mb-3  text-gray-600 card-subheading md:pr-16 text-justify",
                        },
                      },
                      ol: {
                        props: {
                                    ...
                                    <input
                                      onClick={() => {
                                        onFormClick({
                                          ...
                                          page_source: `${webinar_Data.PageSEO.PageTitle}`,
                                          label: `${webinar_Data.FormFields.SubmitButton}`,
                                        });
                                      }}
                                      type="submit"
                                      action="Save"
                                      ...
                                      value={
                                        webinar_Data.FormFields.SubmitButton
                                      }
