          ...
          <div className='relative z-20 px-4 py-24 mx-auto text-center text-white max-w-7xl lg:py-32 '>
            <div className='flex flex-wrap text-white'>
              <div className='relative w-full px-4 mx-auto text-center xl:flex-grow-0 xl:flex-shrink-0'>
                ...
                <p className='mt-0 mb-4  text-black subheading'>{webinar_Data.Type}</p>
              </div>
            </div>
          </div>
          ...
          <div className='max-w-5xl mx-auto'>
            <div className='flex flex-col items-start md:flex-row'>
              <div className='w-full space-y-5 md:w-3/5 md:pr-16'>
                <p
                  className={`inline-block py-1 pl-4 pr-4 mb-0 -ml-0 hyperlink  leading-5 text-black transform -translate-y-2  rounded ${webinar_Data.categoryStyle}`}
                >
                ...
                <h2 className=' card-heading  text-black sm: md:'>You&apos;ll Learn</h2>
                    ...
                    <li className='mb-2' key='content'>
                      <div className='w-fill flex  text-gray-600 md:pr-16'>
                        <div className=' block w-4 h-4 relative flex-none'>
                          <svg
                            className='w-5 h-5 mr-1 text-black mt-4'
                            fill='currentColor'
                            viewBox='0 0 20 20'
                ...
                <h2 className='card-heading   text-black sm: md:'>Your Panelists</h2>
                  ...
                  {webinar_Data.Panelists.map((member) => (
                    <div className='text-center pr-6 ' key={member}>
                      <div className=' block w-40 h-40 relative '>
                        <Image
                          layout='fill'
                          className='mx-auto rounded-full mb-6 object-cover border-2 border-black'
                ...
                <div className='relative z-10 h-auto p-8 py-10 overflow-hidden bg-white border-b-2 border-gray-300 rounded-lg shadow-2xl px-7'>
                  ...
                  <div className='relative w-full mt-6 space-y-8'>
                    <div className='relative'>
                      <label className='absolute px-2 ml-2 -mt-3 card-subheading text-gray-600 bg-white'>
                        First Name
                      </label>
                      <input
                        type='text'
                        className='block w-full px-4 py-4 mt-2  placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black'
                        placeholder='John'
                      />
                    </div>
                    <div className='relative'>
                    ...
                    <div className='relative  text-center'>
                      ...
                      <button
                        ...
                        className='inline-block w-full px-5 py-4 button  text-center text-white transition duration-200 bg-black 
                                            rounded-r-xl rounded-b-xl button transition duration-200 hover:bg-gray-500 ease'
                      >
                        Submit
                      </button>
                    </div>
