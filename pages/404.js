...
export default function Error () {
    return (
        ...
        <div className="absolute top-0 right-0 h-40 lg:h-80 lg:mr-44 lg:mt-24"><Image  src="/404/five-stars.svg" alt="" width={400} height={300}/></div>
        ...
        <div className="relative mt-10  px-4 mx-auto">
          <div className="max-w-3xl mx-auto">
            <Link  href="/about-KTern" passHref>
              ...
              <div className="h-7"><Image  src="/404/kternlogo.png" width={200} height={100} alt="" /></div>
              </a>
            </Link>
