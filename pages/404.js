      ...
      <div className="justify-center items-center flex-col mt-6  px-4 ">
        <div className=" mx-auto">
          ...
          <div className=" m-auto text-center  ">
            ...
            <Link
              href="/"
              className="  max-w-1/2 inline-block py-3 px-10  bg-white hover:bg-gray-50 hover:text-black shadow text-lg text-black font-bold rounded-r-xl rounded-b-xl transition duration-200 custom-card-subheading">
      ...
      <div className=" grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mx-auto p-10 xl:px-64 mt-6">
        {data.QuickLinks.map((dt) => (
          ...
          >
            ...
            <Link
              href={dt.CTAUrl}
              className="text-sm text-dxaas-primary border-b-2 border-dotted border-dxaas-primary">
