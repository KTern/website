...
<path fillRule="evenodd" clipRule="evenodd" d="M0 49V0H49H50L49.99 0.00980377C76.595 0.537064 98 22.2688 98 49C98 76.062 76.062 98 49 98C21.938 98 0 76.062 0 49Z" fill="#F28900"/>
</svg></div>
    ...
    <div className="hidden lg:block opacity-50 flex-shrink-0 w-full max-w-md px-3">
         ...
         <section className="w-full pt-8 bg-white sm:pt-12 md:pt-16">
            ...
            <section className="bg-white">
                ...
                <Link  href="/pricing" passHref><a className=" border-2 border-black inline-block py-3 px-10 bg-black hover:bg-gray-300 hover:text-black shadow button  uppercase text-white rounded-r-xl rounded-b-xl transition duration-200 ">See Pricing</a></Link>
