    ...
    return (
        <Layout>
            ...
            <div className="relative pt-12 md:pt-16 pb-40  bg-maps-secondary border-b-4 border-maps-primary">
                ...
                <div className="rounded-3xl md:rounded-6xl md:rounded-br-none h-80 w-100 relative"><Image className="rounded-3xl bg-maps-secondary md:rounded-6xl" layout="fill" src="/product/maps/maps_2.svg" alt="" /></div>
