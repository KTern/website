            ...
            <div className="px-10 mx-auto max-w-7xl">
                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="relative col-span-12 mb-10 space-y-4 md:col-span-6 lg:col-span-4">
                        ...
                        <Link href="#_" passHref><a className="block card-subheading  font-semibold leading-tight text-gray-700 hover:text-gray-900">Everything you need to know about SAP S/4HANA Assessment using KTern  </a></Link>
                    </div>
                    ...
                    <div className="relative col-span-12 mb-10 space-y-4 md:col-span-6 lg:col-span-4">
                        ...
                        <p className="tiny-subheading font-bold text-gray-400 uppercase">Resources</p>
                        <Link href="#_" passHref ><a className="block card-subheading  font-semibold leading-tight text-gray-700 hover:text-gray-900">KTern: The ultimate tool to unearth your Enterprise Structure in SAP Material Management (MM)</a></Link>
                    </div>
                    ...
                    <div className="relative col-span-12 mb-10 space-y-4 md:col-span-6 lg:col-span-4">
                        ...
                        <p className="tiny-subheading font-bold text-gray-400 uppercase">Resources</p>
                        <Link href="#_" passHref><a className="block card-subheading  font-semibold leading-tight text-gray-700 hover:text-gray-900">How to perform SAP Data Archiving Analysis the right way using KTern? </a></Link>
                    </div>
                </div>
                </div>
                </section>
