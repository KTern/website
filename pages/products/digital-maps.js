            ...
            <div className="relative pt-12 md:pt-16 pb-40  bg-maps-secondary border-b-4 border-maps-primary">
                <div className="relative container mx-auto px-4">
                    <div className="max-w-2xl mx-auto text-center mb-12 md:mb-20">
                        <h2 className="mb-3   font-bold heading">Digital Maps</h2>
                        <span className="mb-3  text-black subheading">Build your Business Case for SAP Digital Transformation with KTern’s Digital Maps</span> 
                            <div><br />
                                <Link  href="#" passHref><a className="hidden  lg:inline-block py-3 px-10 bg-maps-primary hover:bg-gray-100 hover:text-black shadow text-white font-bold rounded-l-xl rounded-t-xl transition duration-200 uppercase tiny-heading">Contact Sales</a></Link>
                            </div>
                    </div>
                </div>
...
<path fillRule="evenodd" clipRule="evenodd" d="M82.9727 164.999C82.8152 165 82.6577 165 82.5 165C36.9365 165 0 128.063 0 82.5C0 36.9365 36.9365 0 82.5 0C128.063 0 165 36.9365 165 82.5C165 83.2975 164.989 84.0924 164.966 84.8844L165.21 165H82.9714L82.9727 164.999Z" fill="#FF9970"/>
                            ...
                            <div className="w-full lg:w-1/2 md:px-20  lg:mb-20 lg:mb-0 flex items-center">
                                <div className="w-full text-center lg:text-left">
                                    <div className="max-w-md mx-auto lg:mx-0">
                                    <h2 className="mb-3  font-bold card-heading">
                                        <span className="card-heading">Business Process assessment</span>
           ...
           {/* /Testimonial Section */}
            ...
            <div className="px-10 mx-auto max-w-7xl">
                <div className="flex items-center justify-between w-full pb-5 mb-8 border-b border-gray-200">
                    <h2 className="card-heading font-bold text-gray-800">Related Resources</h2>
                            <Link href="#_" passHref>
                                <a className="flex items-center text-base font-semibold text-maps-primary hover:text-maps-secondary group">
                        <span className="tiny-heading">View More Posts</span>
                        <svg className="w-4 h-4 mt-0.5 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg>
                        </a>
                    </Link>
                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="relative col-span-12 mb-10 pb-10 space-y-4 md:col-span-6 lg:col-span-4 shadow-lg hover:shadow-xl rounded " >
                        ...
                        <p className="tiny-subheading font-bold text-gray-400 uppercase pl-4 pr-2">Resources</p>
                        <Link href="#_" passHref><a className="block card-subheading  font-semibold leading-tight text-gray-700 hover:text-gray-900 pl-4 pr-2">Everything you need to know about SAP S/4HANA Assessment using KTern  </a></Link>
                        <Link href="/features/digital-projects"  passHref>
                                                        <a className="absolute inline-flex items-center pb-1 font-medium text-maps-primary hover:border-blue-500 group bottom-0">
                                                        <span className="tiny-heading group-hover:text-maps-secondary pl-4">View Article</span>
                                                        <svg className="w-5 h-6 mt-1 ml-2 group-hover:text-maps-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                                                        </svg>
                                                        </a>
                                                    </Link>  
                    ...
                    <div className="relative col-span-12 mb-10 pb-10 space-y-4 md:col-span-6 lg:col-span-4 shadow-lg hover:shadow-xl rounded " >
                        ...
                        <p className="tiny-subheading font-bold text-gray-400 uppercase pl-4 pr-2">Resources</p>
                        <Link href="#_" passHref><a className="block card-subheading  font-semibold leading-tight text-gray-700 hover:text-gray-900 pl-4 pr-2">KTern: The ultimate tool to unearth your Enterprise Structure in SAP Material Management (MM)</a></Link>
                        <Link href="/features/digital-projects"  passHref>
                                                        <a className="absolute inline-flex items-center pb-1 font-medium text-maps-primary hover:border-blue-500 group bottom-0">
                                                        <span className="tiny-heading group-hover:text-maps-secondary pl-4">View Article</span>
                                                        <svg className="w-5 h-6 mt-1 ml-2 group-hover:text-maps-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="relative col-span-12 mb-10 pb-10 space-y-4 md:col-span-6 lg:col-span-4 shadow-lg hover:shadow-xl rounded " >
                        ...
                        <p className="tiny-subheading font-bold text-gray-400 uppercase pl-4 pr-2">Resources</p>
                        <Link href="#_" passHref><a className="block card-subheading  font-semibold leading-tight text-gray-700 hover:text-gray-900 pl-4 pr-2">How to perform SAP Data Archiving Analysis the right way using KTern?  </a></Link>
                        <Link href="/features/digital-projects"  passHref>
                                                        <a className="absolute inline-flex items-center pb-1 font-medium text-maps-primary hover:border-blue-500 group bottom-0">
                                                        <span className="tiny-heading group-hover:text-maps-secondary pl-4">View Article</span>
                                                        <svg className="w-5 h-6 mt-1 ml-2 group-hover:text-maps-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <section className="bg-white">
                ...
                <div className="relative py-6 overflow-hidden rounded-lg bg-gradient-to-r from-black to-maps-400 lg:py-12 md:px-6 lg:p-16 lg:flex lg:items-center lg:justify-between md:shadow-xl md:bg-purple-1000">
