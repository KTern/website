            ...
            <div className="relative pt-12 md:pt-16 pb-40  bg-process-secondary border-b-4 border-process-primary">
                <div className="relative container mx-auto px-4">
                    <div className="max-w-2xl mx-auto text-center mb-12 md:mb-20">
                        <h2 className="mb-3    heading">Digital Process</h2>
                        <span className="mb-3  text-black subheading">Create a Digital Footprint and continuously optimize your processes with Digital Process  </span> 
                            <div><br />
                                <Link  href="#" passHref><a className="hidden  lg:inline-block py-3 px-10 bg-process-primary hover:bg-gray-100 hover:text-black shadow text-white  rounded-r-xl rounded-b-xl transition duration-200 uppercase hyperlink">Contact Sales</a></Link>
                            </div>
                    </div>
                </div>
                <div className="absolute inset-x-0  max-w-2xl mx-auto px-4 bg-process-secondary shadow-2xl rounded-2xl ">
                <div className="rounded-3xl md:rounded-6xl md:rounded-tl-none h-80 w-100 relative"><Image className="rounded-3xl md:rounded-6xl" layout="fill" src="/product/process/process_1.svg" alt="" /></div>
                        ...
                        <div className="flex flex-wrap -mx-4">
                            <div className="hidden sm:block w-full lg:w-1/2 px-4 flex items-center justify-center">
                                <div className="relative" style={{zIndex: 0}}>
                                    <div className="h-128 w-full relative"><Image className="bg-gray-100 rounded-3xl md:rounded-tl-none" width={500} height={400}  src="/product/process/process_2.svg" alt=""/></div>
...
<path fillRule="evenodd" clipRule="evenodd" d="M82.9727 164.999C82.8152 165 82.6577 165 82.5 165C36.9365 165 0 128.063 0 82.5C0 36.9365 36.9365 0 82.5 0C128.063 0 165 36.9365 165 82.5C165 83.2975 164.989 84.0924 164.966 84.8844L165.21 165H82.9714L82.9727 164.999Z" fill="#6758EE"/>
                            ...
                            <div className="w-full lg:w-1/2 md:px-20 lg:mb-12 lg:mb-20 lg:mb-0 flex items-center">
                                <div className="w-full text-center lg:text-left">
                                    ...
                                    <p className="mb-6 text-black  card-subheading">Manage your Business processes in a holistic way, with KTern you can describe your processes both in a business and from an IT perspective ensuring the Business Documentation and System Reality are always synchronized </p>
                                    <Link href="/features/digital-process"  passHref>
                            ...
                            <div className="absolute mr-4" style={{zIndex: 0}}>
                                <div><Image width={500} height={400} className="bg-gray-100 rounded-3xl md:rounded-tl-none" src="/product/process/process_2.svg" alt=""/></div>
                                    <div  className="animate-pulse hidden md:block absolute w-60 h-40" style={{top:'-2rem', right: '3rem', zIndex: -1}}><svg width="98" height="98" viewBox="0 0 98 98" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fillRule="evenodd" clipRule="evenodd" d="M0 49V0H49H50L49.99 0.00980377C76.595 0.537064 98 22.2688 98 49C98 76.062 76.062 98 49 98C21.938 98 0 76.062 0 49Z" fill="#170C76"/>
</svg>
</div>
...
<path fillRule="evenodd" clipRule="evenodd" d="M82.9727 164.999C82.8152 165 82.6577 165 82.5 165C36.9365 165 0 128.063 0 82.5C0 36.9365 36.9365 0 82.5 0C128.063 0 165 36.9365 165 82.5C165 83.2975 164.989 84.0924 164.966 84.8844L165.21 165H82.9714L82.9727 164.999Z" fill="#6758EE"/>
                            ...
                            <div className="w-full lg:w-1/2 md:px-20  lg:mb-20 lg:mb-0 flex items-center">
                                <div className="w-full text-center lg:text-left">
                                    ...
                                    <div className="max-w-sm mx-auto lg:mx-0">
                                    <p className="mb-6 text-black  card-subheading">KTern&apos;s Analytics Wizard provides a 360 degree bird view acting as a single source of truth for your Custom process Profiling providing insights about your existing processes.</p>
                                    <Link href="/features/digital-process"  passHref>
                                                        <a className="inline-flex items-center pb-1  text-black hover:border-blue-500 group ">
                                                        <span className="hyperlink group-hover:text-gray-400">Learn More</span>
                                                        <svg className="w-5 h-6 mt-1 ml-2 group-hover:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<path fillRule="evenodd" clipRule="evenodd" d="M82.9727 164.999C82.8152 165 82.6577 165 82.5 165C36.9365 165 0 128.063 0 82.5C0 36.9365 36.9365 0 82.5 0C128.063 0 165 36.9365 165 82.5C165 83.2975 164.989 84.0924 164.966 84.8844L165.21 165H82.9714L82.9727 164.999Z" fill="#6758EE"/>
                             ...
                             <div className="w-full lg:w-1/2 md:px-20 lg:mb-12 lg:mb-20 lg:mb-0 flex items-center">
                                <div className="w-full text-center lg:text-left">
                                    ...
                                    <div className="max-w-sm mx-auto lg:mx-0">
                                    <p className="mb-6 text-black  card-subheading">Automated custom code remediation for built upon pre-defined SAP Tribal Simplification Scenarios with auto-learning potential of manual code correction </p>
                                    <Link href="/features/digital-process"  passHref>
                                                        <a className="inline-flex items-center pb-1  text-black hover:border-blue-500 group ">
                                                        <span className="hyperlink group-hover:text-gray-400">Learn More</span>
                                                        <svg className="w-5 h-6 mt-1 ml-2 group-hover:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="invisible lg:visible w-full lg:w-1/2 px-4 flex items-center justify-center">
                            <div className="absolute mr-4" style={{zIndex: 0}}>
                                <div className="h-100 w-100 relative "><Image width={500} height={400}  className="bg-gray-100 rounded-3xl md:rounded-tl-none" src="/product/process/process_2.svg" alt=""/></div>
                                    <div  className="animate-pulse hidden md:block absolute w-60 h-40" style={{top:'-2rem', right: '3rem', zIndex: -1}}><svg width="98" height="98" viewBox="0 0 98 98" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fillRule="evenodd" clipRule="evenodd" d="M0 49V0H49H50L49.99 0.00980377C76.595 0.537064 98 22.2688 98 49C98 76.062 76.062 98 49 98C21.938 98 0 76.062 0 49Z" fill="#170C76"/>
</svg>
</div>
...
<path fillRule="evenodd" clipRule="evenodd" d="M82.9727 164.999C82.8152 165 82.6577 165 82.5 165C36.9365 165 0 128.063 0 82.5C0 36.9365 36.9365 0 82.5 0C128.063 0 165 36.9365 165 82.5C165 83.2975 164.989 84.0924 164.966 84.8844L165.21 165H82.9714L82.9727 164.999Z" fill="#6758EE"/>
                            ...
                            <div className="w-full lg:w-1/2 md:px-20  lg:mb-20 lg:mb-0 flex items-center">
                                <div className="w-full text-center lg:text-left">
                                    ...
                                    <div className="max-w-sm mx-auto lg:mx-0">
                                    <p className="mb-6 text-black leading-loose card-subheading">Automated training scenario and stakeholder recommendations in view of the process transformation is Provided based on the Configuration of your current business process as well as KTern&apos;s S4HANAPEDIA Engine&apos;s data empowered intelligence</p>
                                    <Link href="/features/digital-process"  passHref>
                                                        <a className="inline-flex items-center pb-1  text-black hover:border-blue-500 group ">
                                                        <span className="hyperlink group-hover:text-gray-400">Learn More</span>
                                                        <svg className="w-5 h-6 mt-1 ml-2 group-hover:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
           ...
           <div className="px-20 py-10">
                <div className="px-10">
                <h2 className="section-heading text-center mb-4">Digital process Bots</h2>
               
                </div>
                <Carousel className="bots flex p-10  " responsive={responsive}>
                    <div className="p-3 bots-card flex-row justify-center items-center shadow-xl  border-2 border-process-400 text-center ">
                ...
                <div className="flex flex-wrap lg:flex-nowrap justify-center">
                    ...
                    <div className="px-8 py-16 border border-white">
                       ...
                       <div className="absolute top-0 right-0"><Image width="10%" height="10%"  src="/atis-assets/elements/quote-grey.svg" alt=""/></div>
                        <div className="px-4 md:px-10">
                            <h3 className="mb-8 card-subheading text-white">Tonight I had interdum at ante porta, eleifend feugiat nunc. In semper euismod me a accumsan. Thanks! 👏💥</h3>
                           ...
                           <div className="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full"><Image width="60%" height="60%" className="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full" src="data:image/jpeg;base64," alt=""/></div>
                            <p className="mb-6 md:mb-0 hyperlink text-gray-300">TIA O’Halleran, NYC</p>
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="px-8 py-16 border border-white">
                      ...
                      <div className="absolute top-0 left-0"><Image width="10%" height="10%"  src="/atis-assets/elements/quote-grey.svg" alt=""/></div>
                        <div className="absolute top-0 right-0"><Image width="10%" height="10%"  src="/atis-assets/elements/quote-grey.svg" alt=""/></div>
                        <div className="px-4 md:px-10">
                            <h3 className="mb-8 card-subheading text-white">Thanks, feugiat tellus a sad tincidunt ultrices. Phasellus non libero tempus odio vestibulum ultricies.</h3>
                            <div className="flex flex-wrap items-center">
                           <div className="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full"><Image width="60%" height="60%" className="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full" src="data:image/jpeg;base64," alt=""/></div>
                            <p className="mb-6 md:mb-0 hyperlink text-gray-300">Alice Kenowski, NYC</p>
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="px-8 py-16 border border-white">
                      ...
                      <div className="absolute top-0 left-0"><Image width="10%" height="10%"  src="/atis-assets/elements/quote-grey.svg" alt=""/></div>
                        <div className="absolute top-0 right-0"><Image width="10%" height="10%"  src="/atis-assets/elements/quote-grey.svg" alt=""/></div>
                        <div className="px-4 md:px-10">
                            <h3 className="mb-8 card-subheading text-white">This time ut augue ut magna rutrum ultricies nec nec leo. Proin tempor, mauris sad senne lorem.</h3>
                            <div className="flex flex-wrap items-center">
                           <div className="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full"><Image width="60%" height="60%" className="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full" src="data:image/jpeg;base64," alt=""/></div>
                            <p className="mb-6 md:mb-0 hyperlink text-gray-300">Lea Diamse, NYC</p>
                            </div>
                        </div>
                        </div>
                    </div>
         ...
         <section className="w-full pt-8 bg-white sm:pt-12 md:pt-16">
                   ...
                   <div className="relative col-span-12 space-y-3 md:col-span-5 lg:col-span-3 shadow-lg hover:shadow-xl rounded p-4" >
                    ...
                    <Image className="bg-secondary object-cover object-center w-full h-full transition duration-500 ease-out transform scale-100 hover:scale-105" src="/product/process/process_3.svg" alt="resource" layout="fill"/>
                    </a> 
                    </Link>
                    </div>
                    <div className="p-4">
                   ...
                   <Link href="#_"  passHref>
                    ...
                    <Link href="#_" passHref>
                    <a className="relative block w-full h-44 overflow-hidden rounded"> 
                    <Image className="object-cover bg-secondary object-center w-full h-full transition duration-500 ease-out transform scale-100 hover:scale-105" src="/product/process/process_3.svg" alt="resource" layout="fill"/>
                    </a> 
                    </Link>
                    </div>
                    <div className="p-4">
          ...
          {/* / Resources Setion */}
            ...
            <section className="bg-white">
                ...
                <div className="relative py-6 overflow-hidden  bg-gradient-to-r from-black to-process-400 lg:py-12 md:px-6 lg:p-16 lg:flex lg:items-center lg:justify-between md:shadow-xl md:bg-purple-1000">
                <div className="absolute top-0 right-0 hidden w-full -mt-20 transform rotate-45 translate-x-1/2 bg-white sm:block h-96 opacity-5"></div>
                <div className="absolute top-0 left-0 hidden w-full -mt-20 transform rotate-45 -translate-x-1/2 bg-white sm:block h-96 opacity-5"></div>
                <div className="relative p-6  md:p-0 md:pb-4">
                <h2 className="card-heading   leading-9 text-white  sm:leading-10">Get started with your DXaaS Journey</h2>
                ...
                <Link  href="/pricing" passHref><a className="  inline-block py-3 px-10 bg-black hover:bg-gray-100 hover:text-black shadow button  uppercase text-white  rounded-r-xl rounded-b-xl transition duration-200 ">See Pricing</a></Link>
                  <Link  rel="noopener noreferrer" href="https://app.ktern.com" passHref><a target="_blank" className="  inline-block py-3 px-10 bg-white hover:bg-gray-50 hover:text-black shadow button uppercase text-black  rounded-r-xl rounded-b-xl transition duration-200 border-2 border-black">Try it free</a></Link>
                </div>
                </div>
                </div>
            </section> 
