...
export default function Digital_Projects () {
    return (
        <Layout>
            ...
            <div className="relative pt-12 md:pt-16 pb-32 md:pb-64 bg-project-secondary border-b-4 border-project-primary">
                <div className="relative container mx-auto px-4">
                    <div className="max-w-2xl mx-auto text-center mb-12 md:mb-20">
                        <h2 className="mb-3 text-4xl lg:text-5xl font-bold custom-heading">Digital Process</h2>
                        <span className="mb-3 text-1xl text-black custom-subheading">Create a Digital Footprint and continuously optimize your processes with Digital Process </span> 
                            <div><br />
                            ...
                            <div className="w-full lg:w-1/2 md:px-20 lg:mb-12 lg:mb-20 lg:mb-0 flex items-center">
                                <div className="w-full text-center lg:text-left">
                                    ...
                                    <h2 className="mb-3 text-xl lg:text-5xl font-bold font-heading">
                                        <span className="md:custom-heading">Tracking, monitoring and orchestration of enterprise operations</span>
                                        
                                    </h2>
                                    </div>
                                    <div className="max-w-sm mx-auto lg:mx-0">
                                    <p className="mb-6 text-gray-400 leading-loose custom-card-subheading">Manage your Business processes in a holistic way, with KTern you can describe your processes both in a business and from an IT perspective ensuring the Business Documentation and System Reality are always synchronized</p>
                        ...
                        <div className="flex flex-wrap -mx-20">
                            ...
                            <div className="w-full lg:w-1/2 md:px-20  lg:mb-20 lg:mb-0 flex items-center">
                                <div className="w-full text-center lg:text-left">
                                    <div className="max-w-md mx-auto lg:mx-0">
                                    <h2 className="mb-3 text-xl lg:text-5xl font-bold font-heading">
                                        <span className="md:custom-heading">Analytics Wizard</span>
                                        
                                    </h2>
                                    </div>
                                    <div className="max-w-sm mx-auto lg:mx-0">
                                    <p className="mb-6 text-gray-400 leading-loose custom-card-subheading">KTern's Analytics Wizard provides a 360 degree bird view acting as a single source of truth for your Custom process Profiling providing insights about your existing processes.</p>
                        ...
                        <div className="flex flex-wrap -mx-4">
                            ...
                            <div className="w-full lg:w-1/2 md:px-20 lg:mb-12 lg:mb-20 lg:mb-0 flex items-center">
                                <div className="w-full text-center lg:text-left">
                                    <div className="max-w-md mx-auto lg:mx-0">
                                    <h2 className="mb-3 text-xl lg:text-5xl font-bold font-heading">
                                        <span className="md:custom-heading">Custom Code Remediation</span>
                                       
                                    </h2>
                                    </div>
                                    <div className="max-w-sm mx-auto lg:mx-0">
                                    <p className="mb-6 text-gray-400 leading-loose custom-card-subheading">Automated custom code remediation for built upon pre-defined SAP Tribal Simplification Scenarios with auto-learning potential of manual code correction</p>
                            ...
                            <div className="w-full lg:w-1/2 md:px-20  lg:mb-20 lg:mb-0 flex items-center">
                                <div className="w-full text-center lg:text-left">
                                    ...
                                    <h2 className="mb-3 text-xl lg:text-5xl font-bold font-heading">
                                        ...
                                        <span className=" md:custom-heading">Enablement Advisory</span>
                                    </h2>
                                    </div>
                                    <div className="max-w-sm mx-auto lg:mx-0">
                                    <p className="mb-6 text-gray-400 leading-loose custom-card-subheading">Automated training scenario and stakeholder recommendations in view of the process transformation is Provided based on the Configuration of your current business process as well as KTern's S4HANAPEDIA Engine's data empowered intelligence</p>
            ...
            <section className="w-full py-8 bg-white sm:py-12 md:py-16">
                <div className="px-10 mx-auto max-w-7xl">
                    ...
                    <div className="relative col-span-12 mb-10 space-y-4 md:col-span-6 lg:col-span-4">
                        ...
                        <a href="#_" className="block text-xl font-medium leading-tight text-gray-700 hover:text-gray-900"> The Ultimate SAP Custom Code Migration Guide using KTern </a>
                    </div>
                    ...
                    <p className="text-xs font-bold text-gray-400 uppercase">Resources</p>
                    <a href="#_" className="block text-xl font-medium leading-tight text-gray-700 hover:text-gray-900">Why is Custom Code Adaptation required for S/4HANA Conversion Project? </a>
                    </div>
                    ...
                    <p className="text-xs font-bold text-gray-400 uppercase">Resources</p>
                    <a href="#_" className="block text-xl font-medium leading-tight text-gray-700 hover:text-gray-900">How KTern can alleviate your Custom Code Migration challenges? </a>
                    </div>
                    </div>
                </div>
            </section>
            ...
            <h2 className="text-3xl font-extrabold leading-9 tracking-tight text-white sm:text-4xl sm:leading-10">Streamline your Enterprise Operations with KTern </h2>
