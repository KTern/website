...
export default function Webinar () {
    ...
    <Layout > 
        ...
        <div className="container mx-auto py-10">
            <section className="w-full py-8 bg-white sm:py-20 bg-secondary" >
                ...
                <div className="box-content relative flex items-center w-full h-auto max-w-2xl py-5 mx-auto overflow-hidden xl:w-1/3   via-transparent">
                    ...
                    <div className="flex px-6 space-x-6 transition w-full duration-500 ease-out transform xl:pl-6 h-94" >
                        ...
                        <div className="flex flex-col flex-shrink-0 w-full overflow-hidden  shadow-lg">
                            ...
                            <div className="block  w-full w-60 h-40 relative transition duration-200 ease-out transform hover:scale-110">
                                    ...
                                    <Link href="/webinars/webinar-1" className="block" passHref>
                                        ...
                                        <span className="block mt-3 card-subheading text-gray-500 sm:text-sm">
                                            If you want to learn the tips and tricks to building the perfect landing page you&apos;ve got to follow these fd...
                                                    ...
                                                    <div className="items-center mt-6 sm:flex">
                                    <div className="relative">
                                        <p className="text-xs font-medium leading-5 text-gray-500">
                                            <Link href="#_" className="hyperlink">Edson Frainlar</Link>
                                            <span className="mx-1">·</span><time className="ml-1 hyperlink">January 21, 2022</time>
                                        </p>
                                    </div>
                                </div>
                                                </a>
