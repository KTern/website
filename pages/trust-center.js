                ...
                <div>
                    ...
                    <h3 className="mt-4 mb-2 text-base font-semibold leading-tight text-gray-900 lg:text-lg">Cloud services</h3>
                        ...
                        <ul className="list-disc text-sm text-gray-500 lg:text-lg">
                           ...
                           <a className="lg:inline-block py-1 px-5 bg-black hover:bg-gray-300 hover:text-black shadow text-base text-white font-bold rounded-l-xl rounded-t-xl transition duration-200" href="#">Learn more</a>
                          </ul>
