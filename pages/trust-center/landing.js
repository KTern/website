...
export default function TrustCenter () {
    return (
        <Layout>
            ...
            <div className="flex flex-col items-center  mx-auto lg:flex-row">
...
KTern hosts its application and data in industry-leading Google Cloud Platform, whose data centers have been thoroughly tested for security, availability and business continuity. For more details, please read the GCP Whitepaper, GCP Trust & Security and the Forrester Report on Data Security Portfolio Vendors.</p>
        ...
        <div id="section-2">
        <h1 className=" heading mb-6 text-left  text-black"> Application Security </h1>
        <p className="mb-6 text-justify subheading text-black">All KTern products are hosted in Google Cloud Platform. The infrastructure for databases and application servers is managed and maintained by the cloud service provider.
