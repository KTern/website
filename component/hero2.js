      ...
      <div className="relative pt-24 pb-16 bg-gray-900 border-b-4 border-purple-600 overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto text-center mb-10 md:mb-10 mt-10">
            ...
            <h2 className="ibm-plex my-6 text-4xl lg:text-5xl text-gray-50 font-bold">
              {data.Heading}
            </h2>
            <p className="max-w-md mx-auto mb-6 text-gray-300 text-lg leading-loose">
              {data.SubHeading}
            </p>
            ...
            {/* <div className="flex items-center justify-center p-2 sm:flex-row sm:pt-4">
								<a
									...
									className={`cursor-pointer	mr-8 sm:ml-0 
									sm:uppercase sm:w-3/4 sm:mt-1 inline-block
									 p-4 w-full md:w-auto  text-white tag-${stream}
									  hover:bg-gray-600 font-medium text-center 
								...
								<a
									...
									className={`cursor-pointer	sm:hidden mr-8 border 
									border-white sm:ml-0 sm:uppercase sm:w-3/4 sm:mt-1 
									inline-block p-4 w-full md:w-auto text-base leading-4
									 text-white bg-gray-700  hover:bg-deep-purple-accent-700
            ...
            {/* <div className="pb-2 pt-6">
								<div className="flex flex-wrap  items-center justify-center">
									...
									<div className="mb-4 w-full md:w-1/2 lg:w-1/4 px-2 sm:hidden">
										<div className="p-8">
											<span
												className={`p-4 text-2xl rounded-2xl 
												tag-${stream} text-white font-semibold 
												animate-pulse`}
											>
												+
											</span>
