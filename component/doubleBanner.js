                    ...
                    {data.map((dt)=>(<Link key="dt" href={dt.CTALink} >
                        <a className=" group w-100 h-auto border-2 hover:border-black space-y-3  shadow-lg hover:shadow-xl  p-4">
                           ...
                           <div className="relative block  overflow-hidden rounded"> 
                            <Image className="bg-secondary object-cover object-center w-full h-full transition duration-500 ease-out transform scale-100 hover:scale-105" width={300} height={230} src={dt.ImageURL} alt="resource" />
                           </div>
                            </div>
                            <div className="px-2 grid-rows-2 gap-4">
                        
                               <div className="w-50 h-20 "> <span className="block card-subheading font-semibold leading-tight text-gray-700 mb-4 hover:text-gray-900 ">{dt.Title}</span></div>
                        <div className=""><Link href={dt.CTALink}  passHref>
