                            ...
                            <div className="w-full mt-16 md:mt-0 md:w-2/5">
                                <div className="relative z-10 h-auto p-8 py-10 overflow-hidden bg-white border-b-2 border-gray-300 rounded-lg shadow-2xl px-7">
                                    ...
                                    <div className="relative  text-center">
                                        ...
                                        <button href="#_" className=" px-5 py-4 text-base font-medium text-center items-center justify-center text-white transition duration-200  bg-black rounded-l-xl rounded-t-xl transition duration-200 hover:bg-gray-500 ease">Submit </button>
