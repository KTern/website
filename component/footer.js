                    ...
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-1/2 lg:w-1/4 px-4 mb-12">
                            ...
                            <ul className="text-lg">
                                <li className="mb-2"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading " href="#">Hello</a></li>
                                <li className="mb-2"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading" href="#">Story</a></li>
                                <li className="mb-2"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading" href="#">Pricing</a></li>
                                <li className="mb-2"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading" href="#">Applications</a></li>
                                <li className="mb-2"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading" href="#">Stats</a></li>
                                <li><a className="text-gray-200 hover:text-gray-100 custom-card-subheading" href="#">Blog</a></li>
                            </ul>
                        </div>
                        <div className="w-1/2 lg:w-1/4 px-4 mb-12">
                            <h3 className="mb-8 lg:mb-8 custom-card-heading text-white">Products</h3>
                            <ul className="text-lg">
                                <li className="mb-2"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading" href="#">Newsletter</a></li>
                                <li className="mb-2"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading" href="#">Features</a></li>
                                <li className="mb-2"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading" href="#">How it works</a></li>
                                <li className="mb-2"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading" href="#">FAQ&apos;s</a></li>
                                <li className="mb-2"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading" href="#">Portfolio</a></li>
                                <li><a className="text-gray-200 hover:text-gray-100 custom-card-subheading" href="#">Team</a></li>
                            </ul>
                        </div>
                             <div className="w-1/2 lg:w-1/4 px-4 mb-12">
                            <h3 className="mb-8 lg:mb-8 custom-card-heading text-white">Products</h3>
                    ...
                    <div className="md:flex items-center justify-end pt-4 sm:pt-10 xl:pt-14">
                        <div className="w-full lg:w-1/2">
                            <div className="flex lg:justify-end mb-6 lg:mb-10">
                               {/* <a className="flex justify-center items-center w-10 h-10 mr-4 bg-white rounded-full" href="#">
                               ...
                               {/* <a className="flex justify-center items-center w-10 h-10 mr-4 bg-white rounded-full" href="#">
                                ...
                                <a className="flex justify-center items-center mr-4  w-10 h-10  bg-white rounded-full" href="#">
                                ...
                                <a className="flex justify-center items-center w-10 h-10 mr-4 bg-white rounded-full" href="#">
                                    <img className="w-5" src="/assets/icons/xing.png"></img>
                                </a>
                            </div>
