			...
			<section className="px-4 py-4 md:py-10 md:px-10 bg-black">
				<div className="md:px-10 mx-auto ">
					<div className="flex flex-wrap -mx-4  border-b border-gray-500 p">
						<div className="w-full  px-4">
							<div className="flex flex-wrap -mx-4">
								...
								<div className="w-1/2 lg:w-1/4 px-4 mb-12">
									...
									<ul className="">
										<li className="mb-2">
											<Link href="/partners">
												<a className="navbar-s text-gray-200 hover:text-gray-100 ">Partners</a>
											</Link>
										</li>
										<li className="mb-2">
											<Link href="/consulting-partner">
												<a className="navbar-s text-gray-200 hover:text-gray-100 ">Consulting Partner</a>
											</Link>
										</li>
										<li className="mb-2">
											<Link href="/technology-partner">
												<a className="navbar-s text-gray-200 hover:text-gray-100 ">Technology Partner</a>
											</Link>
										</li>
										<li className="mb-2">
											<Link href="/partner-register">
												<a className="navbar-s text-gray-200 hover:text-gray-100 ">Become a Partner</a>
											</Link>
										</li>
										<li className="mb-2">
											<Link href="/">
												<a className="navbar-s text-gray-200 hover:text-gray-100 ">Partner Portal</a>
											</Link>
										</li>
									</ul>
								</div>
							...
							<div className="flex">
								...
								<Link href="https://www.g2.com/products/ktern/reviews">
									<a target="_blank" className="mb-4 x-g2-link-home" title="G2">
										{' '}
										<Image width="150px" height="50%" src="/g2.svg" alt="G2" />
									</a>
								</Link>
							</div>
						</div>
					...
					<div className="flex flex-wrap   lg:mb-2 lg:mb-0 ">
						<div className="w-full  lg:w-1/2 lg:mb-2 md:mb-0">
							...
							<p className="py-0 hidden lg:block  text-white ">
								<span className="text-xs">© 2021 KTern All rights reserved.</span>
								<br />
								<span className="text-xs text-gray-200">
									KTern is a registered trademark of Kaar Technologies Pvt. Ltd.
								</span>
							</p>
						</div>
					...
					<p className="lg:hidden  text-white ">
						...
						<span className="navbar-s text-gray-200">
							©2001-2021 All Rights Reserved. KTern is a registered trademark of Kaar Technologies Pvt. Ltd.
						</span>
					</p>
				</div>
			</section>
