...
export default function Footer () {
    ...
    <section className="py-10 2xl:py-20 bg-black">
        <div className="px-10 mx-auto ">
                ...
                <div className="w-full  px-4">
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-1/2 lg:w-1/4 px-4 mb-12">
                            <h3 className="mb-8 lg:mb-8  text-white  custom-card-heading">Zospace</h3>
                            <ul className="text-lg">
                                <li className="mb-2"><Link  href="#"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading">Hello</a></Link></li>
                                <li className="mb-2"><Link  href="#"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading">Story</a></Link></li>
                                <li className="mb-2"><Link  href="#"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading">Pricing</a></Link></li>
                                <li className="mb-2"><Link  href="#"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading">Applications</a></Link></li>
                                <li className="mb-2"><Link  href="#"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading">Stats</a></Link></li>
                                <li><Link  href="#"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading">Blog</a></Link></li>
                            </ul>
                        </div>
                        <div className="w-1/2 lg:w-1/4 px-4 mb-12">
                            <h3 className="mb-8 lg:mb-8 custom-card-heading text-white">Products</h3>
                            <ul className="text-lg">
                                <li className="mb-2"><Link  href="#"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading">Newsletter</a></Link></li>
                                <li className="mb-2"><Link  href="#"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading">Features</a></Link></li>
                                <li className="mb-2"><Link  href="#"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading">How it works</a></Link></li>
                                <li className="mb-2"><Link  href="#"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading">FAQ&apos;s</a></Link></li>
                                <li className="mb-2"><Link  href="#"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading">Portfolio</a></Link></li>
                                <li><Link  href="#"><a className="text-gray-200 hover:text-gray-100 custom-card-subheading">Team</a></Link></li>
                            </ul>
                        </div>
                             <div className="w-1/2 lg:w-1/4 px-4 mb-12">
                            <h3 className="mb-8 lg:mb-8 custom-card-heading text-white">Products</h3>
                    ...
                    <div>
                        <Image width="100%" src="https://images.squarespace-cdn.com/content/v1/5b55cf033917eed698779277/1613654676284-6L5Q8M2C5X2ITXB7VRB3/Available-on-SAP-Store-White-BG-Wallet.png" className="sm:w-20 mb-6 h-auto text-white custom-card-subheading" alt="Available on SAP Store"  height="50%"/>
                    </div>
                </div>
            ...
            <div className="flex flex-wrap   lg:mb-8 lg:mb-0 ">
                <div className="w-full  lg:w-1/2 lg:mb-8 md:mb-0">
                    <div className="md:flex  items-center ">
                        ...
                        <p className=" space-x-5 lg:block text-sm text-white custom-card-subheading">
                    ...
                    <p className="py-0 hidden lg:block text-sm text-white custom-card-subheading">
                            ...
                            <div className="flex lg:justify-end mb-6 lg:mb-10">
                               {/* <Link className="flex justify-center items-center w-10 h-10 mr-4 bg-white rounded-full" href="#">
                                ...
                                <Link className="" href="#" passHref>
                                    <svg className="text-black flex justify-center items-center w-10 h-10 mr-4 bg-white rounded-full" width="20" height="auto" viewBox="0 0 13 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                               ...
                               {/* <Link className="flex justify-center items-center w-10 h-10 mr-4 bg-white rounded-full" href="#">
                                ...
                                <Link className="" href="#" passHref>
                                    <svg className="text-black flex justify-center items-center w-10 h-10 mr-4 bg-white rounded-full" width="16" height="auto" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Link className="" href="#" passHref>
                                    <svg className="text-black flex justify-center items-center w-10 h-10 mr-4 bg-white rounded-full" width="22" height="auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="20" clipRule="evenodd"><path d="M14.862 4.463c-.407-.702-.848-.831-1.747-.88-.898-.059-3.157-.083-5.113-.083-1.96 0-4.22.024-5.117.083-.897.05-1.339.178-1.75.88C.716 5.165.5 6.372.5 8.498v.008c0 2.117.216 3.333.635 4.026.41.701.852.829 1.75.888.897.05 3.156.08 5.117.08 1.956 0 4.215-.03 5.114-.08.899-.059 1.34-.187 1.747-.888.424-.694.638-1.91.638-4.026v-.005-.003c-.001-2.126-.214-3.333-.639-4.035z"/><path d="M6.5 11V6l4 2.5z"/></g></svg>
                                </Link>
                                <Link className="" href="#" passHref>
                                    <Image className="w-5 text-black flex justify-center items-center w-10 h-10 mr-4 bg-white rounded-full" src="/assets/icons/xing.png" alt="Xing" width={40} height={15}/>
                                </Link>
                            </div>
            ...
            <p className="lg:hidden text-sm text-white custom-card-subheading">
