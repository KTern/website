    ...
    <>
            ...
            <div className="w-full grid grid-cols-2 sm:grid-cols-1 sm:px-8 gap-y-4 gap-6">
              ...
              <div className="flex flex-wrap -mx-4">
                <div className="w-1/2 lg:w-1/4 px-4 mb-12">
                  <h3 className="mb-8 lg:mb-2  text-white  navbar-h">
                    Company
                  </h3>
                  <ul className="">
                    <li className="mb-2">
                ...
                <div className="w-1/2 lg:w-1/4 px-4 mb-12">
                  <h3 className="mb-8 lg:mb-2 navbar-h text-white">
                    Resources
                  </h3>
                  <ul className="">
                    <li className="mb-2">
                    ...
                    <li className="mb-2">
                      <Link href="/article" passHref>
                        <a
                          target="_blank"
                          className="navbar-s text-gray-200 hover:text-gray-100 "
                        >
                          Articles
                        </a>
                      </Link>
            ...
            <div className="md:flex  items-center w-full items-center lg:w-1/2 lg:mb-2 md:mb-0">
              ...
              <p className="py-0 hidden lg:block  text-white ">
                <span className="text-xs">
                  © 2021 KTern All rights reserved.
                </span>
                <br />
          ...
          <p className="lg:hidden  text-white ">
            ...
            <span className="navbar-s text-gray-200">
              ©2001-2021 All Rights Reserved. KTern is a registered trademark of
